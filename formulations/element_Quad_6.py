...
children = [
  {'name':'Bar_3', 'nodes':[0, 4, 1], 'var':[var_inter[0],number(0)]},
  {'name':'Bar_3', 'nodes':[2, 5, 3], 'var':[1-var_inter[0],number(1)]},
...
n11  = (1-var_inter[0]) * (0.5-var_inter[0]) * 2
n12  = (1-var_inter[0]) *  var_inter[0] * 4
n13  = var_inter[0] * (var_inter[0]-0.5) * 2
