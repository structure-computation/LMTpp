...
def formulation():
    ...
    H = hooke_isotrope( E, poisson_ratio.expr, dim, "plane stress" )[0] # options['behavior_simplification']
    sigma = mul( H, epsilon )
...
def apply_on_elements_after_solve(unk_subs): # return a string
    ...
    sigma = mul( hooke_isotrope( E, poisson_ratio.expr,  dim, "plane stress" )[0] , epsilon )
