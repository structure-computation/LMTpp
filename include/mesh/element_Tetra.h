...
<<<<<<< HEAD:include/mesh/element_Tetra.h
    ...
    T reg13=reg4*reg3; T reg14=reg11*reg8; reg13=reg10-reg13; T reg15=reg12*reg9; T reg16=pos_nodes[1][2]-pos_nodes[0][2];
    T reg17=reg5*reg16; T reg18=reg11*reg0; T reg19=reg4*reg16; T reg20=reg12*reg1; reg15=reg14-reg15;
    reg14=reg3*reg16; T reg21=reg16*reg13; T reg22=reg12*reg0; T reg23=reg2*reg16; T reg24=reg11*reg1;
    reg14=reg18-reg14; reg19=reg20-reg19; reg17=reg22-reg17; T reg25=reg12*reg2; T reg26=reg4*reg11;
    T reg27=reg12*reg3; T reg28=reg5*reg11; reg23=reg24-reg23; reg21=reg15-reg21; reg28=reg27-reg28;
    reg26=reg25-reg26; reg15=pos[0]-pos_nodes[0][0]; reg17=reg17/reg21; T reg29=pos[1]-pos_nodes[0][1]; reg9=reg9/reg21;
    reg19=reg19/reg21; reg8=reg8/reg21; reg23=reg23/reg21; reg14=reg14/reg21; reg14=reg15*reg14;
    reg17=reg29*reg17; reg19=reg29*reg19; reg23=reg15*reg23; reg8=reg29*reg8; reg9=reg15*reg9;
...
<<<<<<< HEAD:include/mesh/element_Tetra.h
    ...
    reg2=pos_nodes[1][2]*var_inter[0]; reg4=pos_nodes[2][0]*var_inter[1]; T reg11=pos_nodes[3][0]-pos_nodes[0][0]; T reg12=pos_nodes[2][0]-pos_nodes[0][0]; reg1=reg6+reg1;
    reg6=pos_nodes[3][1]*var_inter[2]; T reg13=pos_nodes[2][2]*var_inter[1]; T reg14=reg11*reg5; T reg15=reg8*reg10; T reg16=pos_nodes[3][0]*var_inter[2];
    reg3=reg4+reg3; reg4=reg12*reg10; T reg17=reg7*reg5; reg2=reg9+reg2; reg2=reg13+reg2;
    reg9=pos_nodes[3][2]*var_inter[2]; reg13=reg11*reg8; reg14=reg4-reg14; T reg18=reg12*reg7; reg17=reg15-reg17;
    T reg19=pos_nodes[1][0]-pos_nodes[0][0]; reg16=reg3+reg16; reg3=pos_nodes[1][1]-pos_nodes[0][1]; reg6=reg1+reg6; reg1=reg19*reg17;
    reg16=pos[0]-reg16; T reg20=reg3*reg14; reg13=reg18-reg13; T reg21=var_inter[0]*reg3; T reg22=var_inter[0]*reg19;
    reg9=reg2+reg9; reg6=pos[1]-reg6; reg2=pos_nodes[1][2]-pos_nodes[0][2]; T reg23=reg7*reg2; T reg24=reg3*reg10;
    T reg25=reg2*reg13; T reg26=reg3*reg5; reg1=reg20-reg1; reg20=reg8*reg2; T reg27=reg19*reg10;
    T reg28=reg11*reg2; T reg29=reg19*reg5; T reg30=reg12*reg2; T reg31=var_inter[1]*reg12; reg9=pos[2]-reg9;
    reg22=reg16+reg22; reg16=var_inter[0]*reg2; reg21=reg6+reg21; reg6=var_inter[1]*reg8; reg28=reg27-reg28;
    T reg32=var_inter[2]*reg11; reg20=reg26-reg20; T reg33=var_inter[2]*reg7; reg30=reg29-reg30; reg23=reg24-reg23;
    reg22=reg31+reg22; reg25=reg1-reg25; reg1=reg19*reg7; reg31=reg11*reg3; reg21=reg6+reg21;
    reg6=reg19*reg8; T reg34=var_inter[1]*reg5; reg16=reg9+reg16; reg9=reg12*reg3; reg30=reg30/reg25;
    reg9=reg6-reg9; reg31=reg1-reg31; reg28=reg28/reg25; reg14=reg14/reg25; reg20=reg20/reg25;
    reg23=reg23/reg25; reg22=reg32+reg22; reg17=reg17/reg25; reg32=var_inter[2]*reg10; reg21=reg33+reg21;
    reg16=reg34+reg16; reg23=reg22*reg23; reg14=reg21*reg14; reg28=reg21*reg28; reg20=reg22*reg20;
...
template<class TVI,class TVAL,class T> void get_interp(const Tetra &ne,const Bubble &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    reg3=val[1]*reg3; T reg5=var_inter[1]*reg2; reg4=val[0]*reg4; reg5=val[2]*reg5; reg2=var_inter[2]*reg2;
    reg3=reg4+reg3; reg5=reg3+reg5; reg2=val[3]*reg2; reg2=reg5+reg2; reg1=val[4]*reg1;
    res=reg2+reg1;
