...
Vec<T,2> barycenter( const Element<Bar_3,TN,Node<2,T,TNodalStaticData>,TD,NET> &elem ) {
    Vec<T,2> res;
    T reg0=4*elem.pos(0)[1]; T reg1=4*elem.pos(1)[1]; T reg2=4*elem.pos(0)[0]; T reg3=4*elem.pos(1)[0]; reg3=reg3+reg2;
    reg1=reg1+reg0; T reg4=3*elem.pos(0)[1]; T reg5=3*elem.pos(0)[0]; T reg6=8*elem.pos(2)[1]; T reg7=8*elem.pos(2)[0];
    reg3=reg3-reg7; T reg8=4*elem.pos(2)[1]; reg4=elem.pos(1)[1]+reg4; reg5=elem.pos(1)[0]+reg5; T reg9=4*elem.pos(2)[0];
    reg1=reg1-reg6; reg9=reg9-reg5; T reg10=2*reg1; reg8=reg8-reg4; T reg11=2*reg3;
    T reg12=pow(reg9,2); T reg13=reg9*reg11; T reg14=pow(reg8,2); T reg15=reg8*reg10; reg15=reg13+reg15;
    reg13=reg1*reg10; T reg16=reg3*reg11; reg14=reg12+reg14; reg12=pow(reg14,-4.5); T reg17=3.5*reg15;
    reg16=reg13+reg16; reg13=2.5*reg16; T reg18=pow(reg14,-3.5); T reg19=2.5*reg15; reg17=reg12*reg17;
    reg12=reg18*reg13; reg17=reg19*reg17; reg19=reg18*reg19; reg18=1.5*reg16; T reg20=1.5*reg15;
    T reg21=pow(reg14,-2.5); T reg22=reg20*reg19; reg17=reg12-reg17; reg12=reg21*reg18; reg22=reg12-reg22;
    reg12=pow(reg14,-1.5); reg16=0.5*reg16; reg21=reg21*reg20; reg17=reg20*reg17; reg15=0.5*reg15;
    reg19=reg18*reg19; reg20=reg16*reg12; reg17=reg19+reg17; T reg23=reg15*reg22; T reg24=reg15*reg21;
    reg21=reg16*reg21; reg12=reg15*reg12; reg23=reg21+reg23; reg24=reg20-reg24; reg17=reg19+reg17;
    reg17=reg15*reg17; reg19=reg15*reg24; reg20=pow(reg14,-0.5); T reg25=reg16*reg12; reg23=reg21+reg23;
    reg22=reg16*reg22; reg21=reg20*reg16; reg17=reg22-reg17; reg12=reg15*reg12; reg19=reg25+reg19;
    T reg26=reg15*reg23; reg24=reg16*reg24; reg12=reg21-reg12; reg19=reg25+reg19; reg17=reg22+reg17;
    reg26=reg24-reg26; reg20=reg20*reg15; reg14=pow(reg14,0.5); reg21=2*reg12; reg17=reg22+reg17;
    reg26=reg24+reg26; reg22=2*reg19; reg25=2*reg20; reg23=reg16*reg23; T reg27=reg12*reg25;
    T reg28=reg20*reg21; reg26=reg24+reg26; reg24=reg14*reg21; T reg29=reg20*reg25; reg17=reg15*reg17;
    reg15=reg14*reg22; T reg30=2*reg26; T reg31=reg3*reg12; reg27=reg28+reg27; reg15=reg28-reg15;
    reg28=reg9*reg19; reg17=reg23+reg17; T reg32=reg14*reg25; T reg33=reg8*reg19; T reg34=reg1*reg12;
    reg29=reg24+reg29; reg28=reg31-reg28; reg17=reg23+reg17; reg21=reg12*reg21; reg24=reg9*reg26;
    reg22=reg20*reg22; T reg35=2*reg32; reg25=reg25*reg19; reg33=reg34-reg33; T reg36=reg3*reg19;
    reg27=reg15+reg27; reg15=2*reg29; reg19=reg1*reg19; T reg37=reg8*reg26; reg30=reg14*reg30;
    T reg38=reg3*reg20; T reg39=reg8*reg12; T reg40=reg1*reg20; reg12=reg9*reg12; T reg41=pow(reg14,2);
    reg37=reg19+reg37; reg17=reg23+reg17; T reg42=2*reg27; reg33=reg34+reg33; reg39=reg40+reg39;
    T reg43=reg41*reg15; T reg44=reg32*reg35; T reg45=reg21-reg22; T reg46=reg9*reg20; reg30=reg22+reg30;
    reg25=reg21-reg25; reg20=reg8*reg20; reg12=reg38+reg12; reg24=reg36+reg24; reg28=reg31+reg28;
    reg21=reg20*reg29; reg15=reg32*reg15; reg22=reg32*reg39; T reg47=reg32*reg28; reg42=reg41*reg42;
    T reg48=reg12*reg29; T reg49=reg39*reg29; reg24=reg36+reg24; reg44=reg43+reg44; reg43=reg32*reg33;
    T reg50=reg29*reg35; T reg51=reg20*reg27; T reg52=reg12*reg32; T reg53=reg46*reg27; reg37=reg19+reg37;
    reg35=reg41*reg35; reg17=reg23+reg17; reg25=reg45+reg25; reg23=reg46*reg29; reg30=reg45-reg30;
    reg45=reg3*reg26; reg53=reg48+reg53; reg37=reg19+reg37; reg48=reg47+reg48; T reg54=reg9*reg17;
    T reg55=reg43+reg49; T reg56=reg20*reg32; reg50=reg15+reg50; reg23=reg52+reg23; T reg57=reg46*reg32;
    T reg58=pow(reg41,2); reg25=reg30+reg25; reg30=2*reg35; reg51=reg49+reg51; reg17=reg8*reg17;
    reg26=reg1*reg26; reg24=reg36+reg24; reg15=reg42+reg15; reg42=2*reg44; reg21=reg22+reg21;
    reg49=reg35*reg30; T reg59=reg32*reg37; T reg60=reg29*reg33; reg50=reg15+reg50; reg17=reg26-reg17;
    reg54=reg45-reg54; reg15=reg56*reg44; T reg61=reg35*reg21; T reg62=reg46*reg25; reg51=reg55+reg51;
    reg30=reg58*reg30; T reg63=reg57*reg44; T reg64=reg23*reg35; reg25=reg20*reg25; reg42=reg58*reg42;
    T reg65=reg12*reg27; reg53=reg48+reg53; T reg66=reg39*reg27; T reg67=reg32*reg24; T reg68=reg28*reg29;
    reg15=reg61+reg15; T reg69=reg35*reg53; T reg70=reg57*reg50; reg62=reg65+reg62; reg54=reg45+reg54;
    T reg71=reg60+reg66; T reg72=reg57*reg35; T reg73=pow(reg58,2); T reg74=reg23*reg44; reg60=reg60-reg59;
    reg49=reg42+reg49; reg50=reg56*reg50; reg17=reg26+reg17; reg63=reg64+reg63; reg42=reg21*reg44;
    T reg75=reg35*reg51; reg65=reg68+reg65; T reg76=reg32*reg34; reg25=reg66+reg25; reg66=reg56*reg35;
    T reg77=reg38*reg29; T reg78=reg32*reg31; T reg79=2*reg30; T reg80=reg40*reg29; reg68=reg68-reg67;
    reg80=reg76+reg80; T reg81=reg38*reg27; T reg82=reg32*reg36; T reg83=pow(reg73,2); T reg84=reg72*reg30;
    T reg85=reg31*reg29; T reg86=reg63*reg30; reg27=reg40*reg27; T reg87=reg66*reg49; T reg88=reg30*reg15;
    reg50=reg42+reg50; T reg89=reg69+reg74; reg42=reg75+reg42; T reg90=reg32*reg19; T reg91=reg32*reg40;
    reg29=reg29*reg34; T reg92=reg35*reg22; reg25=reg71+reg25; reg62=reg65+reg62; T reg93=reg52*reg44;
    T reg94=reg35*reg48; reg65=reg68+reg65; T reg95=reg66*reg30; reg79=reg73*reg79; T reg96=reg22*reg44;
    T reg97=reg35*reg55; reg54=reg45+reg54; reg71=reg60+reg71; reg17=reg26+reg17; reg32=reg38*reg32;
    reg77=reg78+reg77; reg49=reg72*reg49; reg70=reg74+reg70; reg74=reg52*reg35; reg27=reg29+reg27;
    T reg98=reg85-reg82; reg29=reg29-reg90; T reg99=pow(reg83,2); T reg100=reg84*reg79; reg49=reg86+reg49;
    T reg101=reg35*reg91; reg62=reg65+reg62; reg79=reg95*reg79; reg87=reg88+reg87; reg50=reg42+reg50;
    T reg102=reg30*reg61; T reg103=reg64*reg30; T reg104=reg74*reg30; reg25=reg71+reg25; reg93=reg94+reg93;
    T reg105=reg30*reg92; reg96=reg97+reg96; reg54=reg45+reg54; reg17=reg26+reg17; T reg106=reg32*reg35;
    T reg107=reg35*reg43; reg70=reg89+reg70; T reg108=reg35*reg80; reg81=reg85+reg81; reg85=reg35*reg47;
    T reg109=reg35*reg77; T reg110=reg91*reg44; reg44=reg32*reg44; reg69=reg69/reg73; reg62=reg62/reg58;
    T reg111=reg35*reg78; reg35=reg35*reg76; reg81=reg98+reg81; reg89=reg89/reg73; reg104=reg104/reg83;
    reg93=reg93/reg73; reg86=reg86/reg83; reg44=reg109+reg44; reg94=reg94/reg73; reg65=reg65/reg58;
    T reg112=reg106*reg30; reg67=reg67/reg58; reg68=reg68/reg58; reg54=reg54/reg41; reg85=reg85/reg73;
    reg49=reg49/reg83; reg103=reg103/reg83; reg100=reg100/reg99; reg70=reg70/reg73; reg105=reg105/reg83;
    reg96=reg96/reg73; reg27=reg29+reg27; reg25=reg25/reg58; reg75=reg75/reg73; reg97=reg97/reg73;
    reg42=reg42/reg73; reg102=reg102/reg83; reg71=reg71/reg58; reg110=reg108+reg110; reg30=reg30*reg101;
    reg59=reg59/reg58; reg50=reg50/reg73; reg17=reg17/reg41; reg88=reg88/reg83; reg60=reg60/reg58;
    reg87=reg87/reg83; reg107=reg107/reg73; reg99=reg79/reg99; reg103=reg89-reg103; reg67=reg54-reg67;
    reg84=reg84/reg83; reg81=reg81/reg58; reg63=reg63/reg73; reg109=reg109/reg73; reg100=reg49-reg100;
    reg97=reg71-reg97; reg64=reg64/reg73; reg47=reg47/reg58; reg107=reg60-reg107; reg44=reg44/reg73;
    reg53=reg53/reg58; reg112=reg112/reg83; reg24=reg24/reg41; reg48=reg48/reg58; reg110=reg110/reg73;
    reg74=reg74/reg73; reg30=reg30/reg83; reg59=reg17-reg59; reg85=reg68-reg85; reg15=reg15/reg73;
    reg83=reg95/reg83; reg99=reg87-reg99; reg61=reg61/reg73; reg35=reg35/reg73; reg51=reg51/reg58;
    reg29=reg29/reg58; reg88=reg50-reg88; reg92=reg92/reg73; reg69=reg62-reg69; reg55=reg55/reg58;
    reg37=reg37/reg41; reg26=reg26/reg41; reg43=reg43/reg58; reg90=reg90/reg58; reg105=reg96-reg105;
    reg82=reg82/reg58; reg45=reg45/reg41; reg94=reg65-reg94; reg111=reg111/reg73; reg108=reg108/reg73;
    reg98=reg98/reg58; reg27=reg27/reg58; reg86=reg70-reg86; reg75=reg25-reg75; reg104=reg93-reg104;
    reg102=reg42-reg102; reg102=reg75-reg102; reg59=reg107+reg59; reg78=reg78/reg58; reg36=reg36/reg41;
    reg105=reg97-reg105; reg104=reg94-reg104; reg67=reg85+reg67; reg99=reg88-reg99; reg100=reg86-reg100;
    reg80=reg80/reg58; reg101=reg101/reg73; reg19=reg19/reg41; reg90=reg26-reg90; reg76=reg76/reg58;
    reg37=reg43+reg37; reg111=reg98-reg111; reg92=reg55-reg92; reg108=reg27-reg108; reg82=reg45-reg82;
    reg84=reg63-reg84; reg109=reg81-reg109; reg64=reg53-reg64; reg103=reg69-reg103; reg77=reg77/reg58;
    reg106=reg106/reg73; reg61=reg51-reg61; reg83=reg15-reg83; reg24=reg47+reg24; reg74=reg48-reg74;
    reg35=reg29-reg35; reg30=reg110-reg30; reg112=reg44-reg112; reg83=reg61-reg83; reg100=reg103-reg100;
    reg23=reg23/reg58; reg72=reg72/reg73; reg92=reg37+reg92; reg101=reg80-reg101; reg52=reg52/reg58;
    reg99=reg102-reg99; reg28=reg28/reg41; reg106=reg77-reg106; reg36=reg78+reg36; reg74=reg24+reg74;
    reg30=reg108-reg30; reg112=reg109-reg112; reg84=reg64-reg84; reg82=reg111+reg82; reg105=reg59+reg105;
    reg73=reg66/reg73; reg21=reg21/reg58; reg22=reg22/reg58; reg33=reg33/reg41; reg90=reg35+reg90;
    reg19=reg76+reg19; reg104=reg67+reg104; reg100=reg104+reg100; reg30=reg90+reg30; reg99=reg105+reg99;
    reg83=reg92+reg83; reg101=reg19+reg101; reg112=reg82+reg112; reg106=reg36+reg106; reg34=reg34/reg41;
    reg84=reg74+reg84; reg52=reg28-reg52; reg91=reg91/reg58; reg72=reg23-reg72; reg73=reg21-reg73;
    reg32=reg32/reg58; reg31=reg31/reg41; reg22=reg33-reg22; reg100=reg112+reg100; reg56=reg56/reg58;
    reg99=reg30+reg99; reg72=reg52-reg72; reg91=reg34-reg91; reg83=reg101+reg83; reg39=reg39/reg41;
    reg84=reg106+reg84; reg12=reg12/reg41; reg73=reg22-reg73; reg58=reg57/reg58; reg32=reg31-reg32;
    reg40=reg40/reg41; reg38=reg38/reg41; reg15=reg1*reg83; reg56=reg39-reg56; reg100=reg9*reg100;
    reg58=reg12-reg58; reg72=reg32+reg72; reg73=reg91+reg73; reg12=reg3*reg84; reg99=reg8*reg99;
    reg17=reg3*reg72; reg56=reg40+reg56; reg19=reg1/reg14; reg83=reg8*reg83; reg21=reg1*reg73;
    reg84=reg9*reg84; reg99=reg15+reg99; reg20=reg20/reg41; reg41=reg46/reg41; reg22=reg3/reg14;
    reg100=reg12+reg100; reg58=reg38+reg58; reg84=reg17-reg84; reg41=reg22-reg41; reg73=reg8*reg73;
    reg22=reg1*reg56; reg23=reg3*reg58; reg72=reg9*reg72; reg99=reg15+reg99; reg20=reg19-reg20;
    reg100=reg12+reg100; reg83=reg21-reg83; reg83=reg21+reg83; reg84=reg17+reg84; reg56=reg8*reg56;
    reg100=reg12+reg100; reg73=reg22+reg73; reg19=reg1*reg20; reg72=reg23+reg72; reg58=reg9*reg58;
    reg24=reg9/reg14; reg25=reg3*reg41; reg99=reg15+reg99; reg14=reg8/reg14; reg73=reg22+reg73;
    reg99=reg15+reg99; reg58=reg25-reg58; reg56=reg19-reg56; reg41=reg9*reg41; reg26=reg24*reg3;
    reg84=reg17+reg84; reg27=reg14*reg1; reg20=reg8*reg20; reg83=reg21+reg83; reg72=reg23+reg72;
    reg100=reg12+reg100; reg24=reg9*reg24; reg14=reg8*reg14; reg73=reg22+reg73; reg26=reg41+reg26;
    reg56=reg19+reg56; reg72=reg23+reg72; reg100=reg12+reg100; reg83=reg21+reg83; reg84=reg17+reg84;
    reg27=reg20+reg27; reg58=reg25+reg58; reg99=reg15+reg99; reg83=reg84+reg83; reg56=reg58+reg56;
    reg73=reg72+reg73; reg27=reg26+reg27; reg14=reg24+reg14; reg99=reg100+reg99; reg12=elem.pos(0)[0]*reg56;
    reg15=reg9*reg27; reg17=reg14*reg3; reg19=reg9*reg56; reg20=elem.pos(0)[1]*reg56; reg21=reg8*reg27;
    reg22=reg8*reg83; reg23=elem.pos(0)[1]*reg73; reg24=elem.pos(0)[1]*reg99; reg25=reg9*reg83; reg26=reg3*reg73;
    reg28=reg14*reg1; reg29=reg1*reg27; reg30=reg8*reg56; reg31=reg1*reg56; reg32=elem.pos(0)[0]*reg99;
    reg33=elem.pos(0)[0]*reg83; reg34=reg1*reg73; reg35=reg9*reg73; reg36=reg3*reg56; reg37=reg8*reg73;
    reg38=elem.pos(0)[1]*reg83; reg39=reg3*reg27; reg40=elem.pos(0)[0]*reg73; reg41=elem.pos(0)[1]*reg27; reg8=reg8*reg14;
    reg20=reg20+reg21; reg28=reg21+reg28; reg32=reg25-reg32; reg25=reg26+reg25; reg23=reg30-reg23;
    reg30=reg30+reg29; reg21=reg34+reg22; reg33=reg35+reg33; reg42=elem.pos(0)[0]*reg27; reg9=reg9*reg14;
    reg35=reg36-reg35; reg43=reg31-reg37; reg38=reg37+reg38; reg37=reg19+reg39; reg40=reg19-reg40;
    reg12=reg12+reg15; reg17=reg15+reg17; reg24=reg22-reg24; reg8=reg41+reg8; reg15=reg34+reg21;
    reg24=reg21+reg24; reg28=reg20+reg28; reg23=reg23+reg30; reg30=reg29+reg30; reg19=reg31+reg43;
    reg38=reg43-reg38; reg20=reg36+reg35; reg21=reg26+reg25; reg32=reg25+reg32; reg33=reg35-reg33;
    reg9=reg42+reg9; reg39=reg39+reg37; reg37=reg40+reg37; reg17=reg12+reg17; reg30=reg23+reg30;
    reg56=0.5*reg56; reg9=reg9/2; reg33=reg33+reg20; reg12=elem.pos(0)[1]*reg14; reg20=reg36+reg20;
    reg39=reg37+reg39; reg17=0.5*reg17; reg38=reg38+reg19; reg19=reg31+reg19; reg27=reg27/2;
    reg22=reg26+reg21; reg23=elem.pos(0)[0]*reg14; reg32=reg21+reg32; reg24=reg15+reg24; reg15=reg34+reg15;
    reg28=0.5*reg28; reg8=reg8/2; reg20=reg33+reg20; reg30=0.16666666666666666667*reg30; reg39=0.16666666666666666667*reg39;
    reg19=reg38+reg19; reg24=reg24+reg15; reg15=reg34+reg15; reg8=reg12+reg8; reg28=reg28/3;
    reg32=reg32+reg22; reg22=reg26+reg22; reg17=reg17/3; reg9=reg23+reg9; reg12=0.16666666666666666667*reg73;
    reg56=reg56/3; reg27=reg14+reg27; reg30=reg30/4; reg28=reg8+reg28; reg17=reg9+reg17;
    reg39=reg39/4; reg15=reg24+reg15; reg8=0.041666666666666666668*reg83; reg19=0.041666666666666666668*reg19; reg56=reg27+reg56;
    reg12=reg12/4; reg20=0.041666666666666666668*reg20; reg22=reg32+reg22; reg99=0.0083333333333333333337*reg99; reg8=reg8/5;
    reg12=reg56-reg12; reg19=reg19/5; reg30=reg28+reg30; reg20=reg20/5; reg39=reg17+reg39;
    reg9=0.0083333333333333333337*reg15; reg14=0.0083333333333333333337*reg22; reg9=reg9/6; reg19=reg30+reg19; reg8=reg12-reg8;
    reg99=reg99/6; reg20=reg39+reg20; reg14=reg14/6; reg8=reg99+reg8; reg14=reg20-reg14;
    reg9=reg19-reg9; res[0]=reg14/reg8; res[1]=reg9/reg8;
...
Vec<T,3> barycenter( const Element<Bar_3,TN,Node<3,T,TNodalStaticData>,TD,NET> &elem ) {
    ...
    T reg5=3*elem.pos(0)[1]; T reg6=4*elem.pos(1)[2]; T reg7=3*elem.pos(0)[0]; T reg8=8*elem.pos(2)[1]; reg1=reg1+reg0;
    reg3=reg3+reg2; T reg9=8*elem.pos(2)[0]; T reg10=3*elem.pos(0)[2]; T reg11=4*elem.pos(2)[1]; reg5=elem.pos(1)[1]+reg5;
    reg1=reg1-reg8; reg3=reg3-reg9; reg7=elem.pos(1)[0]+reg7; T reg12=8*elem.pos(2)[2]; reg6=reg6+reg4;
    T reg13=4*elem.pos(2)[0]; reg13=reg13-reg7; T reg14=2*reg1; reg6=reg6-reg12; reg11=reg11-reg5;
    T reg15=2*reg3; reg10=elem.pos(1)[2]+reg10; T reg16=4*elem.pos(2)[2]; T reg17=reg11*reg14; T reg18=reg13*reg15;
    ...
    reg16=reg16/2; reg20=reg55+reg37; reg32=reg37+reg32; reg28=reg28+reg41; reg24=0.5*reg24;
    reg41=reg57+reg41; reg13=reg13/2; reg21=elem.pos(0)[0]*reg22; reg52=reg60+reg52; reg33=elem.pos(0)[1]*reg22;
    reg36=0.5*reg36; reg26=0.5*reg26; reg34=elem.pos(0)[2]*reg22; reg31=reg62+reg31; reg18=reg18/2;
    reg13=reg21+reg13; reg26=reg26/3; reg21=0.16666666666666666667*reg107; reg38=0.16666666666666666667*reg38; reg55=reg55+reg20;
    reg20=reg32+reg20; reg35=reg45+reg35; reg41=reg28+reg41; reg52=0.16666666666666666667*reg52; reg58=reg58+reg29;
    reg29=reg50+reg29; reg16=reg34+reg16; reg42=reg42/3; reg46=reg46+reg30; reg18=reg22+reg18;
    reg11=reg33+reg11; reg31=0.16666666666666666667*reg31; reg54=reg59+reg54; reg36=reg36/3; reg30=reg27+reg30;
    reg24=reg24/3; reg36=reg11+reg36; reg31=reg31/4; reg55=reg20+reg55; reg24=reg18+reg24;
    reg41=0.041666666666666666668*reg41; reg21=reg21/4; reg30=reg46+reg30; reg26=reg13+reg26; reg52=reg52/4;
    reg29=reg58+reg29; reg54=0.041666666666666666668*reg54; reg42=reg16+reg42; reg38=reg38/4; reg11=0.041666666666666666668*reg122;
    reg35=0.041666666666666666668*reg35; reg11=reg11/5; reg21=reg24-reg21; reg13=0.0083333333333333333337*reg29; reg38=reg42+reg38;
    reg35=reg35/5; reg137=0.0083333333333333333337*reg137; reg41=reg41/5; reg52=reg26+reg52; reg54=reg54/5;
    reg16=0.0083333333333333333337*reg55; reg31=reg36+reg31; reg18=0.0083333333333333333337*reg30; reg13=reg13/6; reg35=reg38+reg35;
    reg16=reg16/6; reg41=reg52+reg41; reg11=reg21-reg11; reg137=reg137/6; reg18=reg18/6;
    reg54=reg31+reg54; reg11=reg137+reg11; reg16=reg41-reg16; reg18=reg54-reg18; reg13=reg35-reg13;
    res[1]=reg18/reg11; res[0]=reg16/reg11; res[2]=reg13/reg11;
