...
typename TNG::T get_det_jac( const Element<Bar_4,TN,TNG,TD,NET> &elem, const TVI &var_inter ) {
    ...
    T reg0=0.66666666666666662966-var_inter[0]; T reg1=0.33333333333333331483-var_inter[0]; T reg2=reg0+reg1; T reg3=reg0-var_inter[0]; T reg4=1-var_inter[0];
    T reg5=reg4*reg2; reg3=reg4*reg3; T reg6=var_inter[0]*reg0; T reg7=reg0*reg1; T reg8=reg1-var_inter[0];
    reg3=reg3-reg6; reg1=var_inter[0]*reg1; T reg9=reg4*reg8; reg5=reg7+reg5; reg8=reg0*reg8;
    reg3=13.5*reg3; reg9=reg9-reg1; T reg10=4.5*reg5; T reg11=elem.pos(2)[1]*reg3; T reg12=elem.pos(0)[0]*reg10;
    reg9=13.5*reg9; T reg13=elem.pos(0)[1]*reg10; T reg14=elem.pos(2)[0]*reg3; reg8=reg8-reg1; T reg15=elem.pos(0)[2]*reg10;
    reg14=reg14-reg12; reg8=4.5*reg8; T reg16=elem.pos(3)[0]*reg9; T reg17=elem.pos(3)[1]*reg9; reg11=reg11-reg13;
    reg3=elem.pos(2)[2]*reg3; reg17=reg11-reg17; reg11=elem.pos(1)[1]*reg8; T reg18=elem.pos(1)[0]*reg8; reg9=elem.pos(3)[2]*reg9;
    reg3=reg3-reg15; reg16=reg14-reg16; reg11=reg17+reg11; reg8=elem.pos(1)[2]*reg8; reg9=reg3-reg9;
    reg18=reg16+reg18; reg9=reg8+reg9; reg3=pow(reg11,2); reg8=pow(reg18,2); reg8=reg3+reg8;
    reg3=pow(reg9,2); reg3=reg8+reg3; reg3=pow(reg3,0.5); reg8=reg18/reg3; reg14=reg11/reg3;
    reg3=reg9/reg3; reg11=reg14*reg11; reg8=reg18*reg8; reg8=reg11+reg8; reg9=reg3*reg9;
    reg9=reg8+reg9; return reg9;
...
Vec<T,2> barycenter( const Element<Bar_4,TN,Node<2,T,TNodalStaticData>,TD,NET> &elem ) {
    Vec<T,2> res;
    T reg0=81*elem.pos(2)[1]; T reg1=27*elem.pos(0)[1]; T reg2=44.999999999999999001*elem.pos(2)[1]; T reg3=17.9999999999999995*elem.pos(0)[1]; T reg4=27*elem.pos(0)[0];
    T reg5=81*elem.pos(2)[0]; T reg6=44.999999999999999001*elem.pos(2)[0]; T reg7=17.9999999999999995*elem.pos(0)[0]; reg2=reg3-reg2; reg3=35.9999999999999995*elem.pos(3)[1];
    T reg8=35.9999999999999995*elem.pos(3)[0]; T reg9=5.4999999999999996392*elem.pos(0)[1]; reg6=reg7-reg6; reg7=8.9999999999999995004*elem.pos(2)[1]; T reg10=5.4999999999999996392*elem.pos(0)[0];
    T reg11=reg5-reg4; T reg12=81*elem.pos(3)[0]; T reg13=reg0-reg1; T reg14=8.9999999999999995004*elem.pos(2)[0]; T reg15=81*elem.pos(3)[1];
    reg10=reg14-reg10; reg8=reg6+reg8; reg6=8.9999999999999995004*elem.pos(1)[0]; reg14=4.4999999999999997502*elem.pos(3)[0]; reg11=reg11-reg12;
    T reg16=27*elem.pos(1)[0]; reg3=reg2+reg3; reg2=4.4999999999999997502*elem.pos(3)[1]; reg9=reg7-reg9; reg13=reg13-reg15;
    reg7=27*elem.pos(1)[1]; T reg17=8.9999999999999995004*elem.pos(1)[1]; reg11=reg11+reg16; reg6=reg8-reg6; reg17=reg3-reg17;
    reg13=reg13+reg7; reg14=reg10-reg14; reg3=0.99999999999999988898*elem.pos(1)[0]; reg8=0.99999999999999988898*elem.pos(1)[1]; reg2=reg9-reg2;
    reg9=2*reg11; reg3=reg14+reg3; reg10=2*reg13; reg14=2*reg6; T reg18=2*reg17;
    reg2=reg8+reg2; reg8=reg17*reg18; T reg19=reg2*reg10; T reg20=reg2*reg18; T reg21=pow(reg3,2);
    T reg22=pow(reg2,2); T reg23=reg6*reg14; T reg24=reg3*reg14; T reg25=reg3*reg9; reg23=reg25+reg23;
    reg25=reg6*reg9; reg14=reg14*reg11; T reg26=reg17*reg10; reg18=reg18*reg13; reg8=reg19+reg8;
    reg22=reg21+reg22; reg20=reg24+reg20; reg18=reg26+reg18; reg8=reg23+reg8; reg19=3.5*reg20;
    reg21=pow(reg22,-4.5); reg14=reg25+reg14; reg23=2.5*reg20; reg24=pow(reg22,-3.5); reg14=reg25+reg14;
    reg25=2.5*reg8; reg19=reg21*reg19; reg18=reg26+reg18; reg19=reg23*reg19; reg23=reg24*reg23;
    reg21=reg13*reg10; reg25=reg24*reg25; reg24=1.5*reg20; reg26=pow(reg22,-2.5); T reg27=reg11*reg9;
    reg18=reg14+reg18; reg14=1.5*reg8; T reg28=reg24*reg23; reg19=reg25-reg19; reg25=reg26*reg14;
    T reg29=1.5*reg18; T reg30=2*reg27; T reg31=2*reg21; reg23=reg14*reg23; reg29=reg26*reg29;
    reg14=pow(reg22,-1.5); reg8=0.5*reg8; reg20=0.5*reg20; reg30=reg27+reg30; reg31=reg21+reg31;
    reg28=reg25-reg28; reg19=reg24*reg19; reg24=reg26*reg24; reg18=0.5*reg18; reg31=reg30+reg31;
    reg21=reg20*reg24; reg25=reg8*reg14; reg26=reg14*reg18; reg27=reg8*reg24; reg19=reg23+reg19;
    ...
    reg30=reg8*reg23; reg14=reg14*reg31; reg24=reg18*reg24; reg28=reg8*reg28; T reg32=reg25*reg18;
    reg19=reg20*reg19; reg29=reg26-reg29; reg26=reg20*reg23; T reg33=reg25*reg31; T reg34=reg23*reg18;
    T reg35=reg20*reg29; reg27=reg30+reg27; reg30=reg32-reg30; reg32=reg25*reg8; reg19=reg28+reg19;
    T reg36=reg8*reg21; reg14=reg14-reg24; reg28=reg24+reg28; reg26=reg32-reg26; reg25=reg25*reg20;
    ...
    reg23=reg23*reg31; reg21=reg18*reg21; reg29=reg8*reg29; reg8=reg6*reg26; reg18=reg25*reg13;
    reg20=reg25*reg11; T reg37=reg22*reg28; T reg38=reg3*reg27; T reg39=reg21+reg29; T reg40=reg17*reg26;
    ...
    T reg42=reg3*reg35; reg34=reg32+reg34; reg32=reg2*reg35; T reg43=2*reg36; T reg44=reg17*reg27;
    T reg45=reg13*reg26; T reg46=reg3*reg26; T reg47=pow(reg22,2); T reg48=reg6*reg25; T reg49=reg20+reg8;
    T reg50=reg17*reg25; T reg51=reg2*reg26; reg41=reg22*reg41; reg30=reg25*reg30; reg38=reg8+reg38;
    reg28=reg28*reg27; reg14=reg26*reg14; reg8=reg37*reg29; reg26=reg47*reg43; reg24=reg33+reg24;
    ...
    reg25=reg3*reg25; reg46=reg48+reg46; reg38=reg49+reg38; reg44=reg45+reg44; reg19=reg39+reg19;
    ...
    reg40=reg23+reg40; reg8=reg26+reg8; reg26=reg25*reg34; reg32=reg44+reg32; reg44=reg14*reg36;
    ...
    reg26=reg55+reg26; reg44=reg59+reg44; reg35=reg17*reg35; reg28=reg41+reg28; reg41=2*reg8;
    reg32=reg54+reg32; reg55=reg2*reg19; reg27=reg13*reg27; reg19=reg3*reg19; T reg66=reg29*reg44;
    T reg67=reg37*reg49; T reg68=reg36*reg24; T reg69=reg60*reg8; T reg70=reg37*reg32; T reg71=reg38*reg36;
    T reg72=reg48*reg36; T reg73=reg29*reg61; T reg74=reg27+reg35; T reg75=reg46*reg34; reg41=reg63*reg41;
    T reg76=reg65*reg8; reg61=reg63*reg61; T reg77=reg14*reg28; T reg78=reg58*reg29; reg26=reg43+reg26;
    ...
    T reg84=reg50*reg34; reg55=reg74+reg55; reg74=reg44*reg8; T reg85=reg70+reg68; reg28=reg75+reg28;
    T reg86=reg29*reg56; T reg87=reg60*reg29; reg77=reg79+reg77; T reg88=reg29*reg26; T reg89=reg58*reg8;
    ...
    T reg98=reg39*reg8; T reg99=reg59*reg8; reg19=reg64+reg19; T reg100=reg29*reg30; reg77=reg79+reg77;
    ...
    reg74=reg86+reg74; reg68=reg29*reg59; T reg107=reg29*reg72; T reg108=reg90*reg8; reg89=reg88+reg89;
    reg28=reg75+reg28; reg8=reg91*reg8; reg75=reg29*reg80; reg84=reg83+reg84; reg83=reg35+reg83;
    ...
    T reg115=reg37*reg45; T reg116=reg78*reg61; T reg117=reg29*reg67; T reg118=reg110*reg94; reg8=reg75+reg8;
    ...
    reg53=reg53/reg41; reg8=reg8/reg41; reg119=reg119/reg109; reg116=reg116/reg109; reg55=reg55/reg47;
    ...
    reg119=reg8-reg119; reg43=reg43/reg63; reg68=reg68/reg41; reg57=reg57/reg63; reg70=reg55-reg70;
    ...
    reg109=reg66-reg109; reg37=reg45-reg37; reg119=reg113-reg119; reg8=reg13/reg22; reg50=reg50/reg47;
    ...
    reg50=reg8-reg50; reg60=reg51-reg60; reg95=reg90+reg95; reg41=reg91+reg41; reg109=reg101+reg109;
    reg110=reg112+reg110; reg121=reg119+reg121; reg118=reg122+reg118; reg63=reg48-reg63; reg118=reg3*reg118;
    reg8=reg13*reg41; reg18=reg17*reg109; reg60=reg50-reg60; reg14=reg14/reg47; reg19=reg17/reg22;
    reg47=reg25/reg47; reg20=reg6/reg22; reg21=reg6*reg110; reg23=reg11*reg95; reg121=reg2*reg121;
    reg118=reg21+reg118; reg24=reg8+reg18; reg14=reg19-reg14; reg47=reg20-reg47; reg121=reg18+reg121;
    reg110=reg3*reg110; reg18=reg11*reg63; reg19=reg13*reg60; reg20=reg17*reg41; reg25=reg6*reg95;
    reg109=reg2*reg109; reg21=reg23+reg21; reg26=reg6*reg63; reg95=reg3*reg95; reg27=reg47*reg11;
    reg28=reg17*reg60; reg41=reg2*reg41; reg29=reg14*reg13; reg30=reg18-reg25; reg32=reg23+reg21;
    reg33=reg2/reg22; reg22=reg3/reg22; reg118=reg21+reg118; reg109=reg20+reg109; reg20=reg19-reg20;
    reg21=reg8+reg24; reg121=reg24+reg121; reg110=reg25+reg110; reg24=reg8+reg21; reg95=reg26-reg95;
    ...
    reg60=reg2*reg60; reg34=reg6*reg47; reg35=reg17*reg14; reg63=reg3*reg63; reg118=reg32+reg118;
    reg32=reg23+reg32; reg25=reg34+reg25; reg34=reg63+reg34; reg18=reg18+reg30; reg30=reg110+reg30;
    reg47=reg3*reg47; reg36=reg22*reg6; reg23=reg23+reg32; reg32=reg118+reg32; reg21=reg35+reg21;
    reg29=reg29+reg28; reg28=reg41+reg28; reg121=reg121+reg24; reg24=reg8+reg24; reg35=reg60+reg35;
    reg109=reg109+reg20; reg27=reg27+reg26; reg26=reg95+reg26; reg14=reg2*reg14; reg8=reg33*reg17;
    reg20=reg19+reg20; reg21=reg35+reg21; reg33=reg2*reg33; reg22=reg3*reg22; reg20=reg109+reg20;
    reg25=reg34+reg25; reg18=reg30+reg18; reg8=reg14+reg8; reg23=reg32+reg23; reg36=reg47+reg36;
    ...
    reg20=reg18+reg20; reg8=reg36+reg8; reg24=reg23+reg24; reg29=reg27+reg29; reg33=reg22+reg33;
    reg21=reg25+reg21; reg18=reg11*reg21; reg22=reg14*reg24; reg23=reg14*reg20; reg25=reg3*reg29;
    reg26=reg6*reg29; reg27=reg6*reg21; reg28=reg21*reg19; reg30=reg13*reg21; reg32=reg17*reg29;
    reg34=reg24*reg19; reg35=reg33*reg6; reg36=reg14*reg29; reg37=reg3*reg21; reg38=reg2*reg20;
    reg6=reg6*reg8; reg39=reg8*reg13; reg40=reg33*reg11; reg41=reg17*reg21; reg42=reg2*reg29;
    reg43=reg20*reg19; reg44=reg3*reg8; reg45=reg14*reg21; reg46=reg2*reg8; reg47=reg3*reg20;
    reg48=reg33*reg13; reg49=reg17*reg8; reg17=reg33*reg17; reg50=reg2*reg21; reg51=reg29*reg19;
    reg52=reg8*reg11; reg53=reg32+reg30; reg32=reg38+reg32; reg28=reg28+reg46; reg34=reg38-reg34;
    reg2=reg2*reg33; reg38=reg8*reg19; reg17=reg46+reg17; reg46=reg41+reg39; reg51=reg51+reg50;
    ...
    reg3=reg3*reg33; reg36=reg14*reg8; reg2=reg38+reg2; reg38=reg30+reg53; reg23=reg23+reg25;
    ...
    reg35=reg45+reg35; reg41=reg41+reg46; reg46=reg39+reg46; reg3=reg36+reg3; reg22=reg22+reg26;
    ...
    reg21=0.5*reg21; reg38=reg30+reg38; reg3=reg3/2; reg35=0.5*reg35; reg8=reg8/2;
    ...
    reg46=reg42+reg46; reg26=reg26+reg43; reg3=reg14+reg3; reg18=reg43+reg18; reg8=reg33+reg8;
    reg21=reg21/3; reg17=reg17/3; reg2=reg19+reg2; reg38=reg53+reg38; reg29=0.16666666666666666667*reg29;
    reg53=reg32+reg53; reg27=reg25+reg27; reg35=reg3+reg35; reg27=0.041666666666666666668*reg27; reg21=reg8+reg21;
...
Vec<T,3> barycenter( const Element<Bar_4,TN,Node<3,T,TNodalStaticData>,TD,NET> &elem ) {
    Vec<T,3> res;
    T reg0=17.9999999999999995*elem.pos(0)[1]; T reg1=44.999999999999999001*elem.pos(2)[1]; T reg2=44.999999999999999001*elem.pos(2)[0]; T reg3=17.9999999999999995*elem.pos(0)[0]; T reg4=27*elem.pos(0)[1];
    T reg5=81*elem.pos(2)[1]; T reg6=27*elem.pos(0)[0]; T reg7=81*elem.pos(2)[0]; T reg8=5.4999999999999996392*elem.pos(0)[1]; T reg9=8.9999999999999995004*elem.pos(2)[1];
    T reg10=35.9999999999999995*elem.pos(3)[0]; reg2=reg3-reg2; reg3=5.4999999999999996392*elem.pos(0)[0]; T reg11=8.9999999999999995004*elem.pos(2)[0]; T reg12=reg7-reg6;
    reg1=reg0-reg1; reg0=35.9999999999999995*elem.pos(3)[1]; T reg13=reg5-reg4; T reg14=81*elem.pos(2)[2]; T reg15=81*elem.pos(3)[0];
    T reg16=17.9999999999999995*elem.pos(0)[2]; T reg17=44.999999999999999001*elem.pos(2)[2]; T reg18=27*elem.pos(0)[2]; T reg19=81*elem.pos(3)[1]; T reg20=27*elem.pos(1)[1];
    T reg21=4.4999999999999997502*elem.pos(3)[1]; reg13=reg13-reg19; T reg22=reg14-reg18; T reg23=8.9999999999999995004*elem.pos(2)[2]; T reg24=5.4999999999999996392*elem.pos(0)[2];
    reg8=reg9-reg8; reg10=reg2+reg10; reg2=8.9999999999999995004*elem.pos(1)[0]; reg9=27*elem.pos(1)[0]; reg12=reg12-reg15;
    T reg25=4.4999999999999997502*elem.pos(3)[0]; reg3=reg11-reg3; reg11=81*elem.pos(3)[2]; reg0=reg1+reg0; reg1=8.9999999999999995004*elem.pos(1)[1];
    T reg26=35.9999999999999995*elem.pos(3)[2]; reg17=reg16-reg17; reg16=8.9999999999999995004*elem.pos(1)[2]; reg26=reg17+reg26; reg1=reg0-reg1;
    reg12=reg12+reg9; reg2=reg10-reg2; reg0=27*elem.pos(1)[2]; reg22=reg22-reg11; reg25=reg3-reg25;
    reg3=0.99999999999999988898*elem.pos(1)[0]; reg10=0.99999999999999988898*elem.pos(1)[1]; reg21=reg8-reg21; reg13=reg13+reg20; reg24=reg23-reg24;
    reg8=4.4999999999999997502*elem.pos(3)[2]; reg16=reg26-reg16; reg17=2*reg1; reg22=reg22+reg0; reg23=2*reg13;
    reg26=2*reg2; T reg27=0.99999999999999988898*elem.pos(1)[2]; reg21=reg10+reg21; reg10=2*reg12; reg8=reg24-reg8;
    reg3=reg25+reg3; reg24=2*reg16; reg25=pow(reg21,2); T reg28=reg1*reg17; T reg29=reg21*reg23;
    T reg30=reg21*reg17; T reg31=reg2*reg26; T reg32=reg3*reg10; T reg33=2*reg22; T reg34=reg3*reg26;
    T reg35=pow(reg3,2); reg8=reg27+reg8; reg31=reg32+reg31; reg28=reg29+reg28; reg27=reg8*reg33;
    reg29=reg16*reg24; reg17=reg17*reg13; reg32=reg1*reg23; reg26=reg26*reg12; T reg36=reg2*reg10;
    reg25=reg35+reg25; reg35=pow(reg8,2); reg30=reg34+reg30; reg34=reg8*reg24; reg35=reg25+reg35;
    reg34=reg30+reg34; reg28=reg31+reg28; reg29=reg27+reg29; reg26=reg36+reg26; reg25=reg16*reg33;
    reg24=reg24*reg22; reg17=reg32+reg17; reg27=3.5*reg34; reg30=pow(reg35,-4.5); reg24=reg25+reg24;
    reg29=reg28+reg29; reg17=reg32+reg17; reg26=reg36+reg26; reg28=2.5*reg29; reg31=reg13*reg23;
    reg32=reg12*reg10; reg24=reg25+reg24; reg25=pow(reg35,-3.5); reg36=2.5*reg34; reg17=reg26+reg17;
    reg27=reg30*reg27; reg28=reg25*reg28; reg27=reg36*reg27; reg26=reg22*reg33; reg30=2*reg31;
    T reg37=2*reg32; T reg38=1.5*reg34; T reg39=1.5*reg29; T reg40=pow(reg35,-2.5); reg36=reg25*reg36;
    reg24=reg17+reg24; reg17=2*reg26; reg30=reg31+reg30; reg25=1.5*reg24; reg37=reg32+reg37;
    reg27=reg28-reg27; reg28=reg40*reg39; reg31=reg38*reg36; reg29=0.5*reg29; reg32=pow(reg35,-1.5);
    T reg41=reg40*reg38; reg24=0.5*reg24; reg17=reg26+reg17; reg34=0.5*reg34; reg31=reg28-reg31;
    reg30=reg37+reg30; reg27=reg38*reg27; reg36=reg39*reg36; reg25=reg40*reg25; reg26=reg29*reg32;
    reg28=reg34*reg31; reg37=reg34*reg41; reg38=reg29*reg41; reg39=reg32*reg24; reg17=reg30+reg17;
    reg27=reg36+reg27; reg36=reg25-reg36; reg25=pow(reg35,-0.5); reg39=reg39-reg38; reg17=0.5*reg17;
    reg37=reg26-reg37; reg28=reg38+reg28; reg26=reg34*reg32; reg27=reg36-reg27; reg28=reg39-reg28;
    reg31=reg29*reg31; reg30=reg34*reg37; reg41=reg24*reg41; reg27=reg34*reg27; reg32=reg32*reg17;
    reg36=reg29*reg26; reg38=reg25*reg24; reg39=reg34*reg28; reg32=reg32-reg41; reg27=reg31+reg27;
    reg38=reg38-reg36; reg31=reg41+reg31; reg30=reg36+reg30; reg36=reg25*reg17; reg40=reg29*reg37;
    reg41=reg34*reg26; T reg42=reg26*reg24; T reg43=reg25*reg29; reg32=reg32-reg31; reg30=reg38-reg30;
    reg39=reg40+reg39; reg27=reg31+reg27; reg40=reg42+reg40; reg42=reg36-reg42; reg25=reg25*reg34;
    reg41=reg43-reg41; reg27=reg32-reg27; reg31=2*reg41; reg35=pow(reg35,0.5); reg32=2*reg30;
    reg36=2*reg25; reg39=reg40+reg39; reg40=reg42-reg40; reg27=reg34*reg27; reg34=reg35*reg31;
    reg38=reg25*reg36; reg42=reg41*reg36; reg43=reg25*reg31; T reg44=reg35*reg32; reg39=reg40-reg39;
    reg26=reg26*reg17; reg37=reg24*reg37; reg28=reg29*reg28; reg38=reg34+reg38; reg24=reg26+reg37;
    reg29=reg25*reg13; reg34=reg1*reg41; reg40=reg21*reg30; T reg45=reg2*reg41; reg42=reg43+reg42;
    T reg46=reg25*reg12; T reg47=2*reg39; T reg48=reg3*reg30; reg43=reg44+reg43; reg44=reg35*reg36;
    reg37=reg37+reg28; reg27=reg28+reg27; reg48=reg45+reg48; reg47=reg35*reg47; reg27=reg37+reg27;
    reg32=reg25*reg32; reg28=reg12*reg41; T reg49=pow(reg35,2); T reg50=reg13*reg41; T reg51=2*reg44;
    T reg52=2*reg38; T reg53=reg29+reg34; reg40=reg34+reg40; reg42=reg43+reg42; reg34=reg2*reg25;
    reg43=reg3*reg41; T reg54=reg25*reg22; T reg55=reg16*reg41; T reg56=reg8*reg30; T reg57=reg3*reg39;
    T reg58=reg2*reg30; reg31=reg41*reg31; reg36=reg36*reg30; reg37=reg24+reg37; T reg59=reg1*reg25;
    T reg60=reg1*reg30; T reg61=reg21*reg41; T reg62=reg21*reg39; reg24=reg26+reg24; reg45=reg46+reg45;
    reg26=reg32+reg31; T reg63=reg22*reg41; reg24=reg24+reg37; reg36=reg31+reg36; reg31=reg21*reg25;
    reg57=reg58+reg57; reg56=reg55+reg56; reg62=reg60+reg62; reg55=reg54+reg55; T reg64=2*reg42;
    T reg65=reg44*reg51; T reg66=reg49*reg52; T reg67=reg3*reg25; T reg68=reg16*reg25; reg61=reg59+reg61;
    reg27=reg37+reg27; reg32=reg47+reg32; reg41=reg8*reg41; reg60=reg50+reg60; reg37=reg16*reg30;
    ...
    T reg77=reg44*reg48; reg57=reg58+reg57; reg56=reg55+reg56; reg25=reg8*reg25; reg36=reg26+reg36;
    reg26=reg32+reg26; reg58=reg28+reg58; reg41=reg68+reg41; reg32=reg63+reg37; reg65=reg66+reg65;
    reg66=reg67*reg38; reg51=reg49*reg51; reg27=reg24+reg27; reg24=reg50+reg60; reg47=reg37+reg47;
    reg62=reg60+reg62; reg37=reg43*reg44; reg60=reg2*reg39; reg75=reg73+reg75; T reg78=reg77+reg76;
    T reg79=reg3*reg27; reg47=reg32+reg47; T reg80=reg1*reg39; reg57=reg58+reg57; T reg81=2*reg51;
    T reg82=reg44*reg56; T reg83=reg44*reg41; T reg84=reg25*reg38; reg32=reg63+reg32; reg66=reg37+reg66;
    reg36=reg26+reg36; reg62=reg24+reg62; reg26=2*reg65; T reg85=reg25*reg42; reg70=reg76+reg70;
    reg71=reg74+reg71; reg76=reg12*reg30; T reg86=reg13*reg30; T reg87=pow(reg49,2); T reg88=reg31*reg44;
    reg73=reg69+reg73; T reg89=reg41*reg38; T reg90=reg67*reg44; reg64=reg64+reg52; T reg91=reg21*reg27;
    reg72=reg52+reg72; reg79=reg60-reg79; reg52=reg44*reg45; reg91=reg80-reg91; T reg92=reg25*reg44;
    T reg93=reg34*reg38; reg39=reg16*reg39; T reg94=reg44*reg53; reg60=reg76+reg60; T reg95=reg61*reg42;
    ...
    reg100=reg51*reg84; T reg113=reg92*reg65; T reg114=reg59*reg42; T reg115=reg44*reg55; reg36=reg25*reg36;
    ...
    reg60=reg76+reg60; reg95=reg34*reg44; T reg130=reg44*reg24; T reg131=reg38*reg53; T reg132=reg86+reg80;
    ...
    reg99=reg99/reg121; reg136=reg136/reg137; reg51=reg51*reg44; reg38=reg184+reg38; reg24=reg24/reg49;
    ...
    reg187=reg162-reg187; reg94=reg24-reg94; reg165=reg144-reg165; reg140=reg103-reg140; reg153=reg36-reg153;
    ...
    reg137=reg100-reg137; reg136=reg155-reg136; reg61=reg61/reg49; reg59=reg59/reg49; reg24=reg13/reg35;
    reg44=reg63-reg44; reg187=reg185-reg187; reg90=reg90/reg87; reg43=reg43/reg49; reg34=reg34/reg49;
    reg165=reg186+reg165; reg27=reg12/reg35; reg140=reg180+reg140; reg138=reg131-reg138; reg177=reg188-reg177;
    ...
    reg59=reg24-reg59; reg88=reg61-reg88; reg137=reg168-reg137; reg87=reg92/reg87; reg171=reg44+reg171;
    reg41=reg41/reg49; reg136=reg112+reg136; reg181=reg165+reg181; reg24=reg22/reg35; reg68=reg68/reg49;
    reg26=reg2*reg136; reg27=reg13*reg124; reg28=reg12*reg118; reg137=reg171+reg137; reg31=reg31/reg49;
    reg29=reg1/reg35; reg30=reg2/reg35; reg67=reg67/reg49; reg32=reg1*reg138; reg87=reg41-reg87;
    reg121=reg149+reg121; reg181=reg21*reg181; reg68=reg24-reg68; reg90=reg34-reg90; reg177=reg81+reg177;
    reg88=reg59-reg88; reg176=reg3*reg176; reg136=reg3*reg136; reg177=reg8*reg177; reg138=reg21*reg138;
    reg24=reg16*reg137; reg34=reg27+reg32; reg36=reg22*reg121; reg67=reg30-reg67; reg31=reg29-reg31;
    reg181=reg32+reg181; reg29=reg13*reg88; reg30=reg16/reg35; reg49=reg25/reg49; reg87=reg68-reg87;
    reg25=reg28+reg26; reg32=reg1*reg124; reg37=reg12*reg90; reg38=reg2*reg118; reg176=reg26+reg176;
    reg181=reg34+reg181; reg26=reg36+reg24; reg177=reg24+reg177; reg24=reg22*reg87; reg39=reg16*reg121;
    reg138=reg32+reg138; reg137=reg8*reg137; reg32=reg29-reg32; reg136=reg38+reg136; reg38=reg37-reg38;
    reg49=reg30-reg49; reg30=reg21/reg35; reg40=reg3/reg35; reg41=reg31*reg13; reg124=reg21*reg124;
    reg42=reg1*reg88; reg43=reg67*reg12; reg118=reg3*reg118; reg44=reg2*reg90; reg34=reg27+reg34;
    reg45=reg28+reg25; reg176=reg25+reg176; reg25=reg36+reg26; reg46=reg29+reg32; reg138=reg32-reg138;
    reg88=reg21*reg88; reg32=reg1*reg31; reg47=reg30*reg13; reg48=reg40*reg12; reg50=reg37+reg38;
    reg136=reg38-reg136; reg38=reg2*reg67; reg51=reg49*reg22; reg121=reg8*reg121; reg52=reg16*reg87;
    reg90=reg3*reg90; reg53=reg42+reg41; reg124=reg42-reg124; reg118=reg44-reg118; reg44=reg44+reg43;
    reg42=reg28+reg45; reg176=reg45+reg176; reg35=reg8/reg35; reg137=reg39+reg137; reg39=reg24-reg39;
    reg181=reg34+reg181; reg34=reg27+reg34; reg177=reg26+reg177; reg121=reg52-reg121; reg26=reg36+reg25;
    reg118=reg118+reg44; reg44=reg43+reg44; reg41=reg41+reg53; reg53=reg124+reg53; reg52=reg52+reg51;
    reg177=reg25+reg177; reg90=reg90+reg38; reg48=reg38+reg48; reg25=reg30*reg1; reg31=reg21*reg31;
    ...
    reg37=reg37+reg50; reg50=reg136+reg50; reg137=reg39-reg137; reg39=reg24+reg39; reg87=reg8*reg87;
    reg32=reg16*reg49; reg67=reg3*reg67; reg36=reg36+reg26; reg26=reg177+reg26; reg47=reg88+reg47;
    reg48=reg90+reg48; reg38=reg32+reg38; reg44=reg118+reg44; reg32=reg87+reg32; reg28=reg42+reg28;
    reg27=reg34+reg27; reg29=reg46+reg29; reg37=reg50+reg37; reg137=reg137+reg39; reg39=reg24+reg39;
    reg43=reg67+reg43; reg25=reg31+reg25; reg49=reg8*reg49; reg24=reg35*reg16; reg40=reg3*reg40;
    reg41=reg53+reg41; reg51=reg51+reg52; reg52=reg121+reg52; reg30=reg21*reg30; reg27=reg28+reg27;
    reg29=reg37+reg29; reg47=reg48+reg47; reg41=reg44+reg41; reg35=reg8*reg35; reg30=reg40+reg30;
    reg38=reg32+reg38; reg25=reg43+reg25; reg39=reg137+reg39; reg51=reg52+reg51; reg24=reg49+reg24;
    reg36=reg26+reg36; reg35=reg30+reg35; reg26=0.99999999999999988898*elem.pos(0)[1]; reg24=reg25+reg24; reg25=0.99999999999999988898*elem.pos(0)[0];
    reg36=reg27+reg36; reg27=0.99999999999999988898*elem.pos(0)[2]; reg38=reg47+reg38; reg39=reg29+reg39; reg51=reg41+reg51;
    reg28=reg24*reg22; reg29=reg38*reg27; reg30=reg24*reg12; reg31=reg13*reg38; reg32=reg8*reg39;
    reg34=reg36*reg27; reg37=reg16*reg51; reg40=reg22*reg38; reg41=reg25*reg36; reg42=reg1*reg51;
    reg43=reg2*reg51; reg44=reg36*reg26; reg45=reg12*reg38; reg46=reg21*reg39; reg47=reg24*reg13;
    reg48=reg1*reg38; reg49=reg21*reg51; reg50=reg39*reg26; reg52=reg35*reg13; reg53=reg1*reg24;
    reg54=reg21*reg38; reg55=reg51*reg26; reg1=reg35*reg1; reg56=reg21*reg24; reg57=reg38*reg26;
    reg58=reg3*reg39; reg59=reg25*reg38; reg60=reg3*reg24; reg61=reg51*reg27; reg62=reg35*reg2;
    reg63=reg8*reg38; reg64=reg35*reg16; reg65=reg16*reg24; reg66=reg25*reg51; reg67=reg3*reg38;
    reg68=reg2*reg24; reg69=reg35*reg22; reg70=reg35*reg12; reg71=reg39*reg27; reg72=reg8*reg51;
    reg2=reg2*reg38; reg73=reg8*reg24; reg74=reg3*reg51; reg75=reg25*reg39; reg16=reg16*reg38;
    reg29=reg29+reg73; reg76=reg54+reg53; reg54=reg55+reg54; reg64=reg73+reg64; reg55=reg24*reg27;
    reg1=reg56+reg1; reg8=reg8*reg35; reg56=reg57+reg56; reg57=reg72+reg16; reg16=reg16+reg28;
    reg21=reg21*reg35; reg73=reg24*reg26; reg52=reg53+reg52; reg61=reg61+reg63; reg53=reg42+reg31;
    ...
    reg74=reg74+reg2; reg3=reg3*reg35; reg32=reg25*reg24; reg2=reg2+reg30; reg59=reg31+reg53;
    ...
    reg30=reg30+reg2; reg8=reg55+reg8; reg3=reg32+reg3; reg64=reg29+reg64; reg62=reg60+reg62;
    reg61=reg61+reg63; reg66=reg66+reg67; reg69=reg63+reg69; reg70=reg67+reg70; reg72=reg72+reg57;
    reg75=reg75+reg74; reg57=reg57+reg16; reg16=reg28+reg16; reg2=reg74+reg2; reg1=reg56+reg1;
    reg52=reg76+reg52; reg76=reg54+reg76; reg46=reg40+reg46; reg21=reg73+reg21; reg28=reg53+reg59;
    reg59=reg31+reg59; reg8=reg8/2; reg26=reg35*reg26; reg37=reg37+reg65; reg21=reg21/2;
    reg62=0.5*reg62; reg38=0.5*reg38; reg64=0.5*reg64; reg40=reg40+reg46; reg1=0.5*reg1;
    reg30=reg2+reg30; reg27=reg35*reg27; reg25=reg25*reg35; reg46=reg65+reg46; reg2=reg75+reg2;
    reg24=reg24/2; reg29=reg58+reg43; reg43=reg45+reg43; reg58=reg41+reg58; reg16=reg57+reg16;
    reg52=reg76+reg52; reg49=reg49+reg48; reg47=reg48+reg47; reg57=reg72+reg57; reg3=reg3/2;
    reg70=reg66+reg70; reg53=reg42+reg53; reg69=reg61+reg69; reg51=0.16666666666666666667*reg51; reg38=reg38/3;
    reg24=reg35+reg24; reg40=reg46+reg40; reg70=0.16666666666666666667*reg70; reg64=reg64/3; reg69=0.16666666666666666667*reg69;
    reg16=reg57+reg16; reg46=reg37+reg46; reg8=reg27+reg8; reg3=reg25+reg3; reg62=reg62/3;
    reg53=reg53+reg28; reg59=reg28+reg59; reg21=reg26+reg21; reg1=reg1/3; reg47=reg49+reg47;
    ...
    reg43=reg29+reg43; reg38=reg24+reg38; reg51=reg51/4; reg16=0.041666666666666666668*reg16; reg69=reg69/4;
    reg64=reg8+reg64; reg62=reg3+reg62; reg39=0.041666666666666666668*reg39; reg59=reg53+reg59; reg1=reg21+reg1;
    reg52=reg52/4; reg70=reg70/4; reg40=reg46+reg40; reg30=0.041666666666666666668*reg30; reg69=reg64+reg69;
    reg40=0.0083333333333333333337*reg40; reg16=reg16/5; reg2=0.0083333333333333333337*reg36; reg51=reg38+reg51; reg47=reg47/5;
    reg52=reg1+reg52; reg59=0.0083333333333333333337*reg59; reg43=0.0083333333333333333337*reg43; reg70=reg62+reg70; reg30=reg30/5;
    reg39=reg39/5; reg40=reg40/6; reg16=reg69+reg16; reg39=reg51+reg39; reg2=reg2/6;
    reg43=reg43/6; reg30=reg70+reg30; reg47=reg52+reg47; reg59=reg59/6; reg2=reg39-reg2;
    reg43=reg30+reg43; reg59=reg47+reg59; reg40=reg16+reg40; res[1]=reg59/reg2; res[0]=reg43/reg2;
    res[2]=reg40/reg2;
