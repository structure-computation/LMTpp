...
typedef typename Pvec::template SubType<0>::T T;
<<<<<<< HEAD:include/mesh/element_Triangle.h
    T reg0=1-var_inter[0]; reg0=reg0-var_inter[1]; T reg1=pos_nodes[1][1]*var_inter[0]; T reg2=pos_nodes[0][1]*reg0; T reg3=pos_nodes[0][0]*reg0;
    T reg4=var_inter[0]*pos_nodes[1][0]; reg1=reg2+reg1; reg2=pos_nodes[2][1]*var_inter[1]; T reg5=pos_nodes[2][0]*var_inter[1]; reg4=reg3+reg4;
    reg5=reg4+reg5; reg3=pos_nodes[1][1]-pos_nodes[0][1]; reg4=pos_nodes[2][1]-pos_nodes[0][1]; T reg6=pos_nodes[2][0]-pos_nodes[0][0]; T reg7=pos_nodes[1][0]-pos_nodes[0][0];
    reg2=reg1+reg2; reg1=reg6*reg3; T reg8=var_inter[0]*reg3; T reg9=var_inter[0]*reg7; T reg10=reg7*reg4;
    reg2=pos[1]-reg2; reg5=pos[0]-reg5; T reg11=var_inter[1]*reg6; reg9=reg5+reg9; reg5=var_inter[1]*reg4;
    reg8=reg2+reg8; reg1=reg10-reg1; reg2=reg7/reg1; T reg12=reg6/reg1; T reg13=reg3/reg1;
    reg1=reg4/reg1; reg8=reg5+reg8; reg9=reg11+reg9; reg1=reg9*reg1; reg12=reg8*reg12;
    reg13=reg9*reg13; reg2=reg8*reg2; var_inter[0]+=reg1-reg12; var_inter[1]+=reg2-reg13;
=======
...
>>>>>>> 512dc2050926bfccc64f86a01cb2ce23c8050af9:include/mesh/element_Triangle.h
...
<<<<<<< HEAD:include/mesh/element_Triangle.h
    ...
    T reg5=val[3]*reg3; reg1=reg2+reg1; reg5=reg1+reg5; reg4=val[4]*reg4; reg1=pow(var_inter[1],2);
    reg4=reg5+reg4; reg5=val[5]*reg1; reg5=reg4+reg5; res=reg5;
=======
...
<<<<<<< HEAD:include/mesh/element_Triangle.h
    T reg0=val[1]*var_inter[0]; T reg1=val[0]+reg0; T reg2=val[2]*var_inter[1]; T reg3=pow(var_inter[0],2); reg1=reg2+reg1;
    T reg4=val[3]*reg3; T reg5=var_inter[0]*var_inter[1]; reg4=reg1+reg4; reg5=val[4]*reg5; reg1=pow(var_inter[1],2);
    T reg6=pow(var_inter[0],3); reg5=reg4+reg5; reg4=val[5]*reg1; T reg7=reg3*var_inter[1]; T reg8=val[6]*reg6;
    reg4=reg5+reg4; reg8=reg4+reg8; reg7=val[7]*reg7; reg4=var_inter[0]*reg1; reg7=reg8+reg7;
    reg4=val[8]*reg4; reg5=pow(var_inter[1],3); reg4=reg7+reg4; reg7=val[9]*reg5; reg7=reg4+reg7;
=======
    T reg0=val[1]*var_inter[0]; T reg1=val[2]*var_inter[1]; T reg2=pow(var_inter[0],2); T reg3=val[0]+reg0; reg3=reg3+reg1;
    T reg4=val[3]*reg2; T reg5=var_inter[0]*var_inter[1]; reg4=reg3+reg4; reg5=val[4]*reg5; reg3=pow(var_inter[1],2);
...
<<<<<<< HEAD:include/mesh/element_Triangle.h
    T reg0=val[1]*var_inter[0]; T reg1=pow(var_inter[0],2); T reg2=val[0]+reg0; T reg3=val[2]*var_inter[1]; T reg4=val[3]*reg1;
    T reg5=var_inter[0]*var_inter[1]; reg2=reg3+reg2; reg5=val[4]*reg5; T reg6=pow(var_inter[1],2); reg4=reg2+reg4;
    reg5=reg4+reg5; reg2=val[5]*reg6; reg4=pow(var_inter[0],3); reg2=reg5+reg2; reg5=val[6]*reg4;
    T reg7=reg1*var_inter[1]; T reg8=var_inter[0]*reg6; reg5=reg2+reg5; reg7=val[7]*reg7; reg7=reg5+reg7;
    reg2=pow(var_inter[1],3); reg8=val[8]*reg8; reg5=pow(var_inter[0],4); T reg9=val[9]*reg2; reg8=reg7+reg8;
    reg7=val[10]*reg5; T reg10=var_inter[1]*reg4; reg9=reg8+reg9; reg7=reg9+reg7; reg8=reg1*reg6;
    reg10=val[11]*reg10; reg9=var_inter[0]*reg2; reg8=val[12]*reg8; reg10=reg7+reg10; reg8=reg10+reg8;
    reg9=val[13]*reg9; reg7=pow(var_inter[1],4); reg10=pow(var_inter[0],5); reg9=reg8+reg9; reg8=val[14]*reg7;
    reg8=reg9+reg8; reg9=val[15]*reg10; T reg11=var_inter[1]*reg5; reg9=reg8+reg9; reg11=val[16]*reg11;
    reg8=reg6*reg4; T reg12=reg1*reg2; reg11=reg9+reg11; reg8=val[17]*reg8; reg8=reg11+reg8;
    reg12=val[18]*reg12; reg9=var_inter[0]*reg7; reg11=pow(var_inter[1],5); reg12=reg8+reg12; reg9=val[19]*reg9;
    reg9=reg12+reg9; reg8=val[20]*reg11; reg12=pow(var_inter[0],6); reg8=reg9+reg8; reg9=val[21]*reg12;
    T reg13=var_inter[1]*reg10; reg13=val[22]*reg13; T reg14=reg6*reg5; reg9=reg8+reg9; reg13=reg9+reg13;
    reg14=val[23]*reg14; reg8=reg4*reg2; reg8=val[24]*reg8; reg9=reg1*reg7; reg14=reg13+reg14;
    reg9=val[25]*reg9; reg13=var_inter[0]*reg11; reg8=reg14+reg8; reg9=reg8+reg9; reg13=val[26]*reg13;
    reg8=pow(var_inter[1],6); reg13=reg9+reg13; reg9=val[27]*reg8; reg9=reg13+reg9; res=reg9;
=======
...
<<<<<<< HEAD:include/mesh/element_Triangle.h
    T reg0=val[1]*var_inter[0]; T reg1=pow(var_inter[0],2); T reg2=val[2]*var_inter[1]; T reg3=val[0]+reg0; T reg4=var_inter[0]*var_inter[1];
    T reg5=val[3]*reg1; reg3=reg2+reg3; T reg6=pow(var_inter[1],2); reg5=reg3+reg5; reg4=val[4]*reg4;
    reg4=reg5+reg4; reg3=val[5]*reg6; reg5=pow(var_inter[0],3); T reg7=reg1*var_inter[1]; reg3=reg4+reg3;
    reg4=val[6]*reg5; reg4=reg3+reg4; reg7=val[7]*reg7; reg3=var_inter[0]*reg6; reg7=reg4+reg7;
    reg3=val[8]*reg3; reg4=pow(var_inter[1],3); T reg8=val[9]*reg4; T reg9=pow(var_inter[0],4); reg3=reg7+reg3;
    reg8=reg3+reg8; reg3=val[10]*reg9; reg7=var_inter[1]*reg5; reg7=val[11]*reg7; T reg10=reg1*reg6;
    reg3=reg8+reg3; reg10=val[12]*reg10; reg8=var_inter[0]*reg4; reg7=reg3+reg7; reg8=val[13]*reg8;
    reg3=pow(var_inter[1],4); reg10=reg7+reg10; reg8=reg10+reg8; reg7=val[14]*reg3; reg7=reg8+reg7;
    res=reg7;
=======
...
<<<<<<< HEAD:include/mesh/element_Triangle.h
    T reg0=val[1]*var_inter[0]; T reg1=pow(var_inter[0],2); T reg2=val[0]+reg0; T reg3=val[2]*var_inter[1]; T reg4=val[3]*reg1;
    reg2=reg3+reg2; T reg5=var_inter[0]*var_inter[1]; reg4=reg2+reg4; reg2=pow(var_inter[1],2); reg5=val[4]*reg5;
    T reg6=val[5]*reg2; T reg7=pow(var_inter[0],3); reg5=reg4+reg5; reg6=reg5+reg6; reg4=val[6]*reg7;
    reg5=reg1*var_inter[1]; reg4=reg6+reg4; reg5=val[7]*reg5; reg6=var_inter[0]*reg2; T reg8=pow(var_inter[1],3);
    reg5=reg4+reg5; reg6=val[8]*reg6; reg6=reg5+reg6; reg4=val[9]*reg8; reg5=pow(var_inter[0],4);
    reg4=reg6+reg4; reg6=val[10]*reg5; T reg9=var_inter[1]*reg7; reg6=reg4+reg6; reg9=val[11]*reg9;
    reg4=reg1*reg2; reg4=val[12]*reg4; T reg10=var_inter[0]*reg8; reg9=reg6+reg9; reg6=pow(var_inter[1],4);
    reg4=reg9+reg4; reg10=val[13]*reg10; reg10=reg4+reg10; reg4=val[14]*reg6; reg9=pow(var_inter[0],5);
    reg4=reg10+reg4; reg10=val[15]*reg9; T reg11=var_inter[1]*reg5; reg10=reg4+reg10; reg11=val[16]*reg11;
    reg4=reg2*reg7; reg11=reg10+reg11; reg4=val[17]*reg4; reg10=reg1*reg8; reg4=reg11+reg4;
    reg10=val[18]*reg10; reg11=var_inter[0]*reg6; reg10=reg4+reg10; reg11=val[19]*reg11; reg4=pow(var_inter[1],5);
    reg11=reg10+reg11; reg10=val[20]*reg4; reg10=reg11+reg10; res=reg10;
=======
...
<<<<<<< HEAD:include/mesh/element_Triangle.h
    ...
    reg2=reg1+reg2; T reg5=val[3]*reg3; T reg6=pow(var_inter[1],2); reg4=val[4]*reg4; reg5=reg2+reg5;
    reg2=val[5]*reg6; T reg7=pow(var_inter[0],3); reg4=reg5+reg4; reg5=val[6]*reg7; reg2=reg4+reg2;
    reg4=reg3*var_inter[1]; reg5=reg2+reg5; reg4=val[7]*reg4; reg2=var_inter[0]*reg6; reg4=reg5+reg4;
    reg2=val[8]*reg2; reg5=pow(var_inter[1],3); reg2=reg4+reg2; reg4=val[9]*reg5; T reg8=pow(var_inter[0],4);
    T reg9=var_inter[1]*reg7; T reg10=val[10]*reg8; reg4=reg2+reg4; reg9=val[11]*reg9; reg10=reg4+reg10;
    reg2=reg3*reg6; reg9=reg10+reg9; reg2=val[12]*reg2; reg4=var_inter[0]*reg5; reg2=reg9+reg2;
    reg4=val[13]*reg4; reg9=pow(var_inter[1],4); reg4=reg2+reg4; reg2=val[14]*reg9; reg10=pow(var_inter[0],5);
    T reg11=var_inter[1]*reg8; reg2=reg4+reg2; reg4=val[15]*reg10; reg11=val[16]*reg11; reg4=reg2+reg4;
    reg2=reg6*reg7; reg11=reg4+reg11; reg2=val[17]*reg2; reg4=reg3*reg5; reg2=reg11+reg2;
    reg4=val[18]*reg4; reg11=var_inter[0]*reg9; reg4=reg2+reg4; reg11=val[19]*reg11; reg2=pow(var_inter[1],5);
    reg11=reg4+reg11; reg4=val[20]*reg2; T reg12=pow(var_inter[0],6); reg4=reg11+reg4; reg11=val[21]*reg12;
    T reg13=var_inter[1]*reg10; reg11=reg4+reg11; reg13=val[22]*reg13; reg4=reg6*reg8; T reg14=reg7*reg5;
    reg4=val[23]*reg4; reg13=reg11+reg13; reg4=reg13+reg4; reg14=val[24]*reg14; reg11=reg3*reg9;
    reg14=reg4+reg14; reg11=val[25]*reg11; reg4=var_inter[0]*reg2; reg13=pow(var_inter[1],6); reg4=val[26]*reg4;
    reg11=reg14+reg11; reg4=reg11+reg4; reg11=val[27]*reg13; reg14=pow(var_inter[0],7); reg11=reg4+reg11;
    reg4=val[28]*reg14; T reg15=var_inter[1]*reg12; reg4=reg11+reg4; reg15=val[29]*reg15; reg11=reg6*reg10;
    reg15=reg4+reg15; reg11=val[30]*reg11; reg4=reg5*reg8; reg11=reg15+reg11; reg4=val[31]*reg4;
    reg15=reg7*reg9; reg15=val[32]*reg15; T reg16=reg3*reg2; reg4=reg11+reg4; reg15=reg4+reg15;
    reg16=val[33]*reg16; reg4=var_inter[0]*reg13; reg11=pow(var_inter[1],7); reg16=reg15+reg16; reg4=val[34]*reg4;
    reg4=reg16+reg4; reg15=val[35]*reg11; reg16=pow(var_inter[0],8); reg14=var_inter[1]*reg14; reg15=reg4+reg15;
    reg16=val[36]*reg16; reg16=reg15+reg16; reg14=val[37]*reg14; reg12=reg6*reg12; reg14=reg16+reg14;
=======
    T reg0=val[1]*var_inter[0]; T reg1=val[2]*var_inter[1]; T reg2=val[0]+reg0; T reg3=pow(var_inter[0],2); reg2=reg2+reg1;
    T reg4=val[3]*reg3; T reg5=var_inter[0]*var_inter[1]; reg4=reg2+reg4; reg5=val[4]*reg5; reg2=pow(var_inter[1],2);
...
<<<<<<< HEAD:include/mesh/element_Triangle.h
    reg10=reg12+reg10; reg9=val[40]*reg9; reg2=reg7*reg2; reg2=val[41]*reg2; reg13=reg3*reg13;
    reg9=reg10+reg9; reg13=val[42]*reg13; reg11=var_inter[0]*reg11; reg2=reg9+reg2; reg11=val[43]*reg11;
    reg3=pow(var_inter[1],8); reg13=reg2+reg13; reg11=reg13+reg11; reg3=val[44]*reg3; res=reg11+reg3;
=======
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_1 &n,const TVI &var_inter,const TVAL &val,T &res) {
    T reg0=val[1]*var_inter[0]; T reg1=val[2]*var_inter[1]; T reg2=val[0]+reg0; reg2=reg1+reg2; res=reg2;
...
<<<<<<< HEAD:include/mesh/element_Triangle.h
    T reg0=val[1]*var_inter[0]; T reg1=pow(var_inter[0],2); T reg2=val[0]+reg0; T reg3=val[2]*var_inter[1]; T reg4=var_inter[0]*var_inter[1];
    T reg5=val[3]*reg1; reg2=reg3+reg2; T reg6=pow(var_inter[1],2); reg4=val[4]*reg4; reg5=reg2+reg5;
    reg2=val[5]*reg6; T reg7=pow(var_inter[0],3); reg4=reg5+reg4; reg2=reg4+reg2; reg4=val[6]*reg7;
    reg5=reg1*var_inter[1]; reg4=reg2+reg4; reg5=val[7]*reg5; reg2=var_inter[0]*reg6; T reg8=pow(var_inter[1],3);
    reg2=val[8]*reg2; reg5=reg4+reg5; reg4=val[9]*reg8; T reg9=pow(var_inter[0],4); reg2=reg5+reg2;
    reg5=val[10]*reg9; T reg10=var_inter[1]*reg7; reg4=reg2+reg4; reg2=reg1*reg6; reg10=val[11]*reg10;
    reg5=reg4+reg5; reg10=reg5+reg10; reg2=val[12]*reg2; reg4=var_inter[0]*reg8; reg5=pow(var_inter[1],4);
    reg4=val[13]*reg4; reg2=reg10+reg2; reg4=reg2+reg4; reg2=val[14]*reg5; reg10=pow(var_inter[0],5);
    reg2=reg4+reg2; reg4=val[15]*reg10; T reg11=var_inter[1]*reg9; reg11=val[16]*reg11; reg4=reg2+reg4;
    reg2=reg6*reg7; reg11=reg4+reg11; reg2=val[17]*reg2; reg4=reg1*reg8; reg2=reg11+reg2;
    reg4=val[18]*reg4; reg11=var_inter[0]*reg5; reg4=reg2+reg4; reg11=val[19]*reg11; reg2=pow(var_inter[1],5);
    T reg12=pow(var_inter[0],6); T reg13=val[20]*reg2; reg11=reg4+reg11; reg13=reg11+reg13; reg4=val[21]*reg12;
    reg11=var_inter[1]*reg10; reg11=val[22]*reg11; T reg14=reg6*reg9; reg4=reg13+reg4; reg11=reg4+reg11;
    reg14=val[23]*reg14; reg4=reg7*reg8; reg14=reg11+reg14; reg4=val[24]*reg4; reg11=reg1*reg5;
    reg4=reg14+reg4; reg11=val[25]*reg11; reg13=var_inter[0]*reg2; reg14=pow(var_inter[1],6); reg13=val[26]*reg13;
    reg11=reg4+reg11; reg4=val[27]*reg14; reg13=reg11+reg13; reg11=pow(var_inter[0],7); reg4=reg13+reg4;
    reg13=val[28]*reg11; T reg15=var_inter[1]*reg12; reg13=reg4+reg13; reg15=val[29]*reg15; reg4=reg6*reg10;
    reg4=val[30]*reg4; T reg16=reg8*reg9; reg15=reg13+reg15; reg4=reg15+reg4; reg16=val[31]*reg16;
    reg13=reg7*reg5; reg13=val[32]*reg13; reg15=reg1*reg2; reg16=reg4+reg16; reg13=reg16+reg13;
    reg15=val[33]*reg15; reg4=var_inter[0]*reg14; reg15=reg13+reg15; reg4=val[34]*reg4; reg13=pow(var_inter[1],7);
    reg4=reg15+reg4; reg15=val[35]*reg13; reg15=reg4+reg15; res=reg15;
=======
    T reg0=val[1]*var_inter[0]; T reg1=val[2]*var_inter[1]; T reg2=pow(var_inter[0],2); T reg3=val[0]+reg0; T reg4=var_inter[0]*var_inter[1];
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const Bubble &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    reg2=var_inter[1]*reg2; reg2=val[2]*reg2; reg4=reg3+reg4; reg2=reg4+reg2; reg1=val[3]*reg1;
    res=reg2+reg1;
