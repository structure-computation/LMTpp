...
typedef typename Pvec::template SubType<0>::T T;
    ...
    T reg5=reg2*reg1; reg5=reg4-reg5; T reg6=pos[0]-pos_nodes[0][0]; T reg7=pos[1]-pos_nodes[0][1]; T reg8=reg0/reg5;
    T reg9=reg1/reg5; T reg10=reg3/reg5; reg5=reg2/reg5; reg10=reg7*reg10; reg9=reg6*reg9;
    reg5=reg7*reg5; reg8=reg6*reg8; var_inter[1]=reg10-reg9; var_inter[0]=reg8-reg5;
...
typedef typename Pvec::template SubType<0>::T T;
    T reg0=1-var_inter[0]; reg0=reg0-var_inter[1]; T reg1=reg0*pos_nodes[0][1]; T reg2=var_inter[0]*pos_nodes[1][1]; T reg3=pos_nodes[2][1]-pos_nodes[0][1];
    T reg4=pos_nodes[1][0]-pos_nodes[0][0]; T reg5=pos_nodes[2][0]-pos_nodes[0][0]; T reg6=var_inter[0]*pos_nodes[1][0]; T reg7=reg0*pos_nodes[0][0]; T reg8=pos_nodes[1][1]-pos_nodes[0][1];
    T reg9=reg5*reg8; T reg10=reg4*reg3; T reg11=var_inter[1]*pos_nodes[2][1]; reg1=reg2+reg1; reg7=reg6+reg7;
    reg2=var_inter[1]*pos_nodes[2][0]; reg9=reg10-reg9; reg11=reg1+reg11; reg2=reg7+reg2; reg2=pos[0]-reg2;
    reg1=reg4/reg9; reg11=pos[1]-reg11; reg6=reg5/reg9; reg7=reg8/reg9; reg9=reg3/reg9;
    reg9=reg9*reg2; reg6=reg6*reg11; reg7=reg7*reg2; reg1=reg1*reg11; var_inter[0]+=reg9-reg6;
    var_inter[1]+=reg1-reg7;
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_7 &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    reg9=reg2*reg6; reg8=reg7+reg8; reg9=val[12]*reg9; reg7=var_inter[0]*reg1; reg9=reg8+reg9;
    reg7=val[13]*reg7; reg8=pow(var_inter[1],4); reg7=reg9+reg7; reg9=val[14]*reg8; T reg10=pow(var_inter[0],5);
    reg9=reg7+reg9; reg7=val[15]*reg10; T reg11=var_inter[1]*reg4; reg7=reg9+reg7; reg11=val[16]*reg11;
    reg9=reg6*reg5; reg11=reg7+reg11; reg9=val[17]*reg9; reg7=reg2*reg1; reg9=reg11+reg9;
    reg7=val[18]*reg7; reg11=var_inter[0]*reg8; reg7=reg9+reg7; reg11=val[19]*reg11; reg9=pow(var_inter[1],5);
    reg11=reg7+reg11; reg7=val[20]*reg9; T reg12=pow(var_inter[0],6); reg7=reg11+reg7; reg11=var_inter[1]*reg10;
    T reg13=val[21]*reg12; T reg14=reg6*reg4; reg11=val[22]*reg11; reg13=reg7+reg13; reg7=reg5*reg1;
    reg14=val[23]*reg14; reg11=reg13+reg11; reg7=val[24]*reg7; reg14=reg11+reg14; reg11=reg2*reg8;
    reg11=val[25]*reg11; reg13=var_inter[0]*reg9; reg7=reg14+reg7; reg11=reg7+reg11; reg13=val[26]*reg13;
    reg7=pow(var_inter[1],6); reg13=reg11+reg13; reg11=val[27]*reg7; reg14=pow(var_inter[0],7); reg11=reg13+reg11;
    reg13=val[28]*reg14; T reg15=var_inter[1]*reg12; T reg16=reg6*reg10; reg13=reg11+reg13; reg15=val[29]*reg15;
    reg11=reg1*reg4; reg16=val[30]*reg16; reg15=reg13+reg15; reg11=val[31]*reg11; reg13=reg5*reg8;
    reg16=reg15+reg16; reg11=reg16+reg11; reg13=val[32]*reg13; reg15=reg2*reg9; reg16=var_inter[0]*reg7;
    reg15=val[33]*reg15; reg13=reg11+reg13; reg15=reg13+reg15; reg16=val[34]*reg16; reg11=pow(var_inter[1],7);
    reg16=reg15+reg16; reg13=val[35]*reg11; reg13=reg16+reg13; res=reg13;
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_6 &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    reg12=pow(var_inter[0],6); reg11=reg8+reg11; reg8=val[20]*reg1; T reg13=var_inter[1]*reg9; T reg14=val[21]*reg12;
    reg8=reg11+reg8; reg14=reg8+reg14; reg13=val[22]*reg13; reg8=reg6*reg7; reg13=reg14+reg13;
    reg8=val[23]*reg8; reg11=reg5*reg4; reg8=reg13+reg8; reg11=val[24]*reg11; reg13=reg2*reg10;
    reg14=var_inter[0]*reg1; reg13=val[25]*reg13; reg11=reg8+reg11; reg13=reg11+reg13; reg14=val[26]*reg14;
    reg8=pow(var_inter[1],6); reg14=reg13+reg14; reg11=val[27]*reg8; reg11=reg14+reg11; res=reg11;
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_5 &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    reg3=val[5]*reg6; reg4=reg5+reg4; reg5=pow(var_inter[0],3); T reg7=val[6]*reg5; T reg8=var_inter[1]*reg2;
    reg3=reg4+reg3; reg7=reg3+reg7; reg8=val[7]*reg8; reg3=var_inter[0]*reg6; reg8=reg7+reg8;
    reg3=val[8]*reg3; reg4=pow(var_inter[1],3); reg3=reg8+reg3; reg7=val[9]*reg4; reg8=pow(var_inter[0],4);
    reg7=reg3+reg7; reg3=val[10]*reg8; T reg9=var_inter[1]*reg5; reg3=reg7+reg3; reg9=val[11]*reg9;
    reg7=reg2*reg6; T reg10=var_inter[0]*reg4; reg9=reg3+reg9; reg7=val[12]*reg7; reg3=pow(var_inter[1],4);
    reg10=val[13]*reg10; reg7=reg9+reg7; reg9=pow(var_inter[0],5); reg10=reg7+reg10; reg7=val[14]*reg3;
    T reg11=val[15]*reg9; T reg12=var_inter[1]*reg8; reg7=reg10+reg7; reg12=val[16]*reg12; reg10=reg6*reg5;
    reg11=reg7+reg11; reg12=reg11+reg12; reg10=val[17]*reg10; reg7=reg2*reg4; reg10=reg12+reg10;
    reg7=val[18]*reg7; reg11=var_inter[0]*reg3; reg12=pow(var_inter[1],5); reg11=val[19]*reg11; reg7=reg10+reg7;
    reg11=reg7+reg11; reg7=val[20]*reg12; reg7=reg11+reg7; res=reg7;
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_8 &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    T reg5=val[3]*reg3; reg2=reg2+reg1; reg5=reg2+reg5; reg2=pow(var_inter[1],2); reg4=val[4]*reg4;
    reg4=reg5+reg4; reg5=val[5]*reg2; T reg6=pow(var_inter[0],3); reg5=reg4+reg5; reg4=val[6]*reg6;
    T reg7=var_inter[1]*reg3; reg4=reg5+reg4; reg5=var_inter[0]*reg2; reg7=val[7]*reg7; reg7=reg4+reg7;
    reg4=pow(var_inter[1],3); reg5=val[8]*reg5; T reg8=val[9]*reg4; T reg9=pow(var_inter[0],4); reg5=reg7+reg5;
    reg8=reg5+reg8; reg5=val[10]*reg9; reg7=var_inter[1]*reg6; T reg10=reg3*reg2; reg7=val[11]*reg7;
    reg5=reg8+reg5; reg7=reg5+reg7; reg10=val[12]*reg10; reg5=var_inter[0]*reg4; reg8=pow(var_inter[1],4);
    reg5=val[13]*reg5; reg10=reg7+reg10; reg5=reg10+reg5; reg7=val[14]*reg8; reg10=pow(var_inter[0],5);
    reg7=reg5+reg7; reg5=val[15]*reg10; T reg11=var_inter[1]*reg9; reg5=reg7+reg5; reg11=val[16]*reg11;
    reg7=reg2*reg6; reg11=reg5+reg11; reg7=val[17]*reg7; reg5=reg3*reg4; reg7=reg11+reg7;
    reg5=val[18]*reg5; reg11=var_inter[0]*reg8; reg11=val[19]*reg11; reg5=reg7+reg5; reg7=pow(var_inter[1],5);
    reg11=reg5+reg11; reg5=val[20]*reg7; T reg12=pow(var_inter[0],6); reg5=reg11+reg5; reg11=val[21]*reg12;
    T reg13=var_inter[1]*reg10; reg11=reg5+reg11; reg13=val[22]*reg13; reg5=reg2*reg9; T reg14=reg6*reg4;
    reg5=val[23]*reg5; reg13=reg11+reg13; reg5=reg13+reg5; reg14=val[24]*reg14; reg11=reg3*reg8;
    reg14=reg5+reg14; reg11=val[25]*reg11; reg5=var_inter[0]*reg7; reg11=reg14+reg11; reg5=val[26]*reg5;
    reg13=pow(var_inter[1],6); reg14=pow(var_inter[0],7); T reg15=val[27]*reg13; reg5=reg11+reg5; reg11=val[28]*reg14;
    reg15=reg5+reg15; reg5=var_inter[1]*reg12; reg11=reg15+reg11; reg15=reg2*reg10; reg5=val[29]*reg5;
    reg5=reg11+reg5; reg15=val[30]*reg15; reg11=reg4*reg9; reg15=reg5+reg15; reg11=val[31]*reg11;
    reg5=reg6*reg8; reg5=val[32]*reg5; T reg16=reg3*reg7; reg11=reg15+reg11; reg5=reg11+reg5;
    reg16=val[33]*reg16; reg11=var_inter[0]*reg13; reg16=reg5+reg16; reg11=val[34]*reg11; reg5=pow(var_inter[1],7);
    reg15=val[35]*reg5; T reg17=pow(var_inter[0],8); reg11=reg16+reg11; reg15=reg11+reg15; reg17=val[36]*reg17;
    reg14=var_inter[1]*reg14; reg14=val[37]*reg14; reg12=reg2*reg12; reg17=reg15+reg17; reg14=reg17+reg14;
    reg12=val[38]*reg12; reg10=reg4*reg10; reg10=val[39]*reg10; reg8=reg9*reg8; reg12=reg14+reg12;
    reg10=reg12+reg10; reg8=val[40]*reg8; reg7=reg6*reg7; reg13=reg3*reg13; reg7=val[41]*reg7;
    reg8=reg10+reg8; reg7=reg8+reg7; reg13=val[42]*reg13; reg5=var_inter[0]*reg5; reg13=reg7+reg13;
    reg5=val[43]*reg5; reg2=pow(var_inter[1],8); reg5=reg13+reg5; reg2=val[44]*reg2; res=reg5+reg2;
...
typename TNG::T get_det_jac( const Element<Triangle,TN,TNG,TD,NET> &elem, const TVI &var_inter ) {
    ...
    reg4=reg0/reg5; T reg6=elem.pos(2)[1]-elem.pos(0)[1]; T reg7=elem.pos(2)[0]-elem.pos(0)[0]; T reg8=elem.pos(2)[2]-elem.pos(0)[2]; T reg9=reg7*reg4;
    T reg10=reg6*reg3; reg5=reg2/reg5; T reg11=reg8*reg5; reg10=reg9+reg10; reg11=reg10+reg11;
    reg9=reg3*reg11; reg10=reg4*reg11; reg10=reg7-reg10; reg9=reg6-reg9; T reg12=reg5*reg11;
    T reg13=pow(reg9,2); T reg14=pow(reg10,2); reg12=reg8-reg12; reg13=reg14+reg13; reg14=pow(reg12,2);
    reg13=reg14+reg13; reg13=pow(reg13,0.5); reg10=reg10/reg13; reg9=reg9/reg13; reg7=reg10*reg7;
    reg13=reg12/reg13; reg4=reg0*reg4; reg6=reg9*reg6; reg9=reg9*reg1; reg3=reg1*reg3;
    reg0=reg10*reg0; reg1=reg13*reg2; reg9=reg0+reg9; reg6=reg7+reg6; reg8=reg13*reg8;
    reg2=reg5*reg2; reg3=reg4+reg3; reg1=reg9+reg1; reg2=reg3+reg2; reg8=reg6+reg8;
    reg0=reg1*reg11; reg3=reg8*reg2; reg0=reg3-reg0; return reg0;
...
Vec<T,2> barycenter( const Element<Triangle,TN,Node<2,T,TNodalStaticData>,TD,NET> &elem ) {
    Vec<T,2> res;
    T reg0=0.33333333333333331483*elem.pos(1)[1]; T reg1=0.33333333333333337034*elem.pos(0)[1]; T reg2=0.33333333333333337034*elem.pos(0)[0]; T reg3=0.33333333333333331483*elem.pos(1)[0]; T reg4=elem.pos(2)[1]-elem.pos(0)[1];
    T reg5=elem.pos(2)[0]-elem.pos(0)[0]; T reg6=elem.pos(1)[1]-elem.pos(0)[1]; T reg7=elem.pos(1)[0]-elem.pos(0)[0]; T reg8=reg6*reg5; T reg9=reg7*reg4;
    reg2=reg3+reg2; reg3=0.33333333333333331483*elem.pos(2)[0]; reg0=reg1+reg0; reg1=0.33333333333333331483*elem.pos(2)[1]; reg8=reg9-reg8;
    reg3=reg2+reg3; reg0=reg1+reg0; reg0=reg8*reg0; reg3=reg8*reg3; reg3=0.5*reg3;
    reg1=0.5*reg8; reg0=0.5*reg0; res[1]=reg0/reg1; res[0]=reg3/reg1;
...
Vec<T,3> barycenter( const Element<Triangle,TN,Node<3,T,TNodalStaticData>,TD,NET> &elem ) {
    ...
    reg10=reg5*reg9; T reg11=reg4*reg9; reg10=reg7-reg10; reg11=reg6-reg11; T reg12=reg3*reg9;
    reg12=reg8-reg12; T reg13=pow(reg11,2); T reg14=pow(reg10,2); reg14=reg13+reg14; reg13=pow(reg12,2);
    reg13=reg14+reg13; reg13=pow(reg13,0.5); reg11=reg11/reg13; reg10=reg10/reg13; reg13=reg12/reg13;
    reg4=reg0*reg4; reg5=reg1*reg5; reg7=reg10*reg7; reg0=reg11*reg0; reg1=reg10*reg1;
    reg6=reg11*reg6; reg8=reg13*reg8; reg7=reg6+reg7; reg13=reg13*reg2; reg1=reg0+reg1;
    reg3=reg2*reg3; reg5=reg4+reg5; reg13=reg1+reg13; reg3=reg5+reg3; reg8=reg7+reg8;
    reg0=0.33333333333333337034*elem.pos(0)[0]; reg1=0.33333333333333331483*elem.pos(1)[0]; reg2=0.33333333333333337034*elem.pos(0)[2]; reg4=0.33333333333333331483*elem.pos(1)[2]; reg5=0.33333333333333331483*elem.pos(1)[1];
    reg6=0.33333333333333337034*elem.pos(0)[1]; reg5=reg6+reg5; reg6=0.33333333333333331483*elem.pos(2)[1]; reg4=reg2+reg4; reg2=0.33333333333333331483*elem.pos(2)[2];
    reg1=reg0+reg1; reg0=0.33333333333333331483*elem.pos(2)[0]; reg7=reg13*reg9; reg10=reg3*reg8; reg0=reg1+reg0;
    reg2=reg4+reg2; reg7=reg10-reg7; reg6=reg5+reg6; reg2=reg7*reg2; reg0=reg7*reg0;
    reg6=reg7*reg6; reg2=0.5*reg2; reg1=0.5*reg7; reg6=0.5*reg6; reg0=0.5*reg0;
    res[1]=reg6/reg1; res[2]=reg2/reg1; res[0]=reg0/reg1;
