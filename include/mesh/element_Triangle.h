...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_7 &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    T reg7=var_inter[1]*reg2; reg4=reg5+reg4; reg5=var_inter[0]*reg1; reg7=val[7]*reg7; reg7=reg4+reg7;
    reg5=val[8]*reg5; reg4=pow(var_inter[1],3); T reg8=val[9]*reg4; reg5=reg7+reg5; reg7=pow(var_inter[0],4);
    T reg9=var_inter[1]*reg6; T reg10=val[10]*reg7; reg8=reg5+reg8; reg10=reg8+reg10; reg9=val[11]*reg9;
    reg5=reg2*reg1; reg9=reg10+reg9; reg5=val[12]*reg5; reg8=var_inter[0]*reg4; reg5=reg9+reg5;
    reg8=val[13]*reg8; reg9=pow(var_inter[1],4); reg10=pow(var_inter[0],5); T reg11=val[14]*reg9; reg8=reg5+reg8;
    reg5=var_inter[1]*reg7; reg11=reg8+reg11; reg8=val[15]*reg10; reg8=reg11+reg8; reg11=reg1*reg6;
    reg5=val[16]*reg5; reg5=reg8+reg5; reg11=val[17]*reg11; reg8=reg2*reg4; reg11=reg5+reg11;
    reg8=val[18]*reg8; reg5=var_inter[0]*reg9; reg8=reg11+reg8; reg5=val[19]*reg5; reg11=pow(var_inter[1],5);
    T reg12=pow(var_inter[0],6); T reg13=val[20]*reg11; reg5=reg8+reg5; reg8=val[21]*reg12; T reg14=var_inter[1]*reg10;
    reg13=reg5+reg13; reg8=reg13+reg8; reg14=val[22]*reg14; reg5=reg1*reg7; reg13=reg6*reg4;
    reg5=val[23]*reg5; reg14=reg8+reg14; reg8=reg2*reg9; reg13=val[24]*reg13; reg5=reg14+reg5;
    reg14=var_inter[0]*reg11; reg8=val[25]*reg8; reg13=reg5+reg13; reg8=reg13+reg8; reg14=val[26]*reg14;
    reg5=pow(var_inter[1],6); reg13=pow(var_inter[0],7); T reg15=val[27]*reg5; reg14=reg8+reg14; reg8=val[28]*reg13;
    reg15=reg14+reg15; reg14=var_inter[1]*reg12; T reg16=reg1*reg10; reg8=reg15+reg8; reg14=val[29]*reg14;
    reg14=reg8+reg14; reg16=val[30]*reg16; reg8=reg4*reg7; reg16=reg14+reg16; reg8=val[31]*reg8;
    reg14=reg6*reg9; reg8=reg16+reg8; reg14=val[32]*reg14; reg15=reg2*reg11; reg16=var_inter[0]*reg5;
    reg15=val[33]*reg15; reg14=reg8+reg14; reg15=reg14+reg15; reg16=val[34]*reg16; reg8=pow(var_inter[1],7);
    reg16=reg15+reg16; reg14=val[35]*reg8; reg14=reg16+reg14; res=reg14;
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_3 &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    reg4=reg5+reg4; reg8=reg4+reg8; reg7=val[7]*reg7; reg4=var_inter[0]*reg3; reg7=reg8+reg7;
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_6 &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    reg5=reg4+reg5; reg7=val[7]*reg7; reg8=reg5+reg8; reg4=var_inter[0]*reg1; reg5=pow(var_inter[1],3);
    reg4=val[8]*reg4; reg7=reg8+reg7; reg4=reg7+reg4; reg7=val[9]*reg5; reg8=pow(var_inter[0],4);
    reg7=reg4+reg7; reg4=val[10]*reg8; T reg9=var_inter[1]*reg6; reg9=val[11]*reg9; reg4=reg7+reg4;
    reg7=reg2*reg1; T reg10=var_inter[0]*reg5; reg7=val[12]*reg7; reg9=reg4+reg9; reg4=pow(var_inter[1],4);
    reg10=val[13]*reg10; reg7=reg9+reg7; reg10=reg7+reg10; reg7=val[14]*reg4; reg9=pow(var_inter[0],5);
    T reg11=val[15]*reg9; T reg12=var_inter[1]*reg8; reg7=reg10+reg7; reg11=reg7+reg11; reg12=val[16]*reg12;
    reg7=reg1*reg6; reg12=reg11+reg12; reg7=val[17]*reg7; reg10=reg2*reg5; reg7=reg12+reg7;
    reg10=val[18]*reg10; reg11=var_inter[0]*reg4; reg10=reg7+reg10; reg11=val[19]*reg11; reg7=pow(var_inter[1],5);
    reg12=pow(var_inter[0],6); reg11=reg10+reg11; reg10=val[20]*reg7; T reg13=val[21]*reg12; reg10=reg11+reg10;
    reg11=var_inter[1]*reg9; reg11=val[22]*reg11; T reg14=reg1*reg8; reg13=reg10+reg13; reg10=reg6*reg5;
    reg14=val[23]*reg14; reg11=reg13+reg11; reg14=reg11+reg14; reg10=val[24]*reg10; reg11=reg2*reg4;
    reg10=reg14+reg10; reg11=val[25]*reg11; reg13=var_inter[0]*reg7; reg11=reg10+reg11; reg13=val[26]*reg13;
    reg10=pow(var_inter[1],6); reg13=reg11+reg13; reg11=val[27]*reg10; reg11=reg13+reg11; res=reg11;
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_4 &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    reg7=reg4+reg7; reg5=reg7+reg5; reg8=val[7]*reg8; reg4=var_inter[0]*reg6; reg8=reg5+reg8;
    reg4=val[8]*reg4; reg5=pow(var_inter[1],3); reg7=pow(var_inter[0],4); T reg9=val[9]*reg5; reg4=reg8+reg4;
    reg9=reg4+reg9; reg4=val[10]*reg7; reg8=var_inter[1]*reg3; T reg10=reg2*reg6; reg8=val[11]*reg8;
    reg4=reg9+reg4; reg8=reg4+reg8; reg10=val[12]*reg10; reg4=var_inter[0]*reg5; reg10=reg8+reg10;
    reg4=val[13]*reg4; reg8=pow(var_inter[1],4); reg4=reg10+reg4; reg9=val[14]*reg8; reg9=reg4+reg9;
    res=reg9;
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_5 &n,const TVI &var_inter,const TVAL &val,T &res) {
    T reg0=val[1]*var_inter[0]; T reg1=val[2]*var_inter[1]; T reg2=pow(var_inter[0],2); T reg3=val[0]+reg0; reg3=reg3+reg1;
    T reg4=val[3]*reg2; T reg5=var_inter[0]*var_inter[1]; T reg6=pow(var_inter[1],2); reg4=reg3+reg4; reg5=val[4]*reg5;
    reg5=reg4+reg5; reg3=val[5]*reg6; reg4=pow(var_inter[0],3); reg3=reg5+reg3; reg5=val[6]*reg4;
    T reg7=var_inter[1]*reg2; T reg8=var_inter[0]*reg6; reg7=val[7]*reg7; reg5=reg3+reg5; reg8=val[8]*reg8;
    reg7=reg5+reg7; reg3=pow(var_inter[1],3); reg5=pow(var_inter[0],4); T reg9=val[9]*reg3; reg8=reg7+reg8;
    reg7=val[10]*reg5; T reg10=var_inter[1]*reg4; reg9=reg8+reg9; reg7=reg9+reg7; reg10=val[11]*reg10;
    reg8=reg2*reg6; reg9=var_inter[0]*reg3; reg10=reg7+reg10; reg8=val[12]*reg8; reg7=pow(var_inter[1],4);
    reg9=val[13]*reg9; reg8=reg10+reg8; reg9=reg8+reg9; reg8=val[14]*reg7; reg10=pow(var_inter[0],5);
    reg8=reg9+reg8; reg9=val[15]*reg10; T reg11=var_inter[1]*reg5; T reg12=reg6*reg4; reg11=val[16]*reg11;
    reg9=reg8+reg9; reg11=reg9+reg11; reg12=val[17]*reg12; reg8=reg2*reg3; reg12=reg11+reg12;
    reg8=val[18]*reg8; reg9=var_inter[0]*reg7; reg8=reg12+reg8; reg9=val[19]*reg9; reg11=pow(var_inter[1],5);
    reg9=reg8+reg9; reg8=val[20]*reg11; reg8=reg9+reg8; res=reg8;
...
template<class TVI,class TVAL,class T> void get_interp(const Triangle &ne,const P_plus_8 &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    T reg4=val[3]*reg2; T reg5=var_inter[0]*var_inter[1]; reg4=reg1+reg4; reg5=val[4]*reg5; reg1=pow(var_inter[1],2);
    reg5=reg4+reg5; reg4=val[5]*reg1; T reg6=pow(var_inter[0],3); T reg7=val[6]*reg6; reg4=reg5+reg4;
    reg5=var_inter[1]*reg2; reg7=reg4+reg7; reg4=var_inter[0]*reg1; reg5=val[7]*reg5; reg5=reg7+reg5;
    reg7=pow(var_inter[1],3); reg4=val[8]*reg4; T reg8=pow(var_inter[0],4); T reg9=val[9]*reg7; reg4=reg5+reg4;
    reg9=reg4+reg9; reg4=val[10]*reg8; reg5=var_inter[1]*reg6; T reg10=reg2*reg1; reg5=val[11]*reg5;
    reg4=reg9+reg4; reg5=reg4+reg5; reg10=val[12]*reg10; reg4=var_inter[0]*reg7; reg10=reg5+reg10;
    reg4=val[13]*reg4; reg5=pow(var_inter[1],4); reg9=pow(var_inter[0],5); T reg11=val[14]*reg5; reg4=reg10+reg4;
    reg11=reg4+reg11; reg4=val[15]*reg9; reg10=var_inter[1]*reg8; reg4=reg11+reg4; reg10=val[16]*reg10;
    reg11=reg1*reg6; reg10=reg4+reg10; reg11=val[17]*reg11; reg4=reg2*reg7; T reg12=var_inter[0]*reg5;
    reg4=val[18]*reg4; reg11=reg10+reg11; reg10=pow(var_inter[1],5); reg12=val[19]*reg12; reg4=reg11+reg4;
    reg11=pow(var_inter[0],6); reg12=reg4+reg12; reg4=val[20]*reg10; T reg13=var_inter[1]*reg9; T reg14=val[21]*reg11;
    reg4=reg12+reg4; reg14=reg4+reg14; reg13=val[22]*reg13; reg4=reg1*reg8; reg12=reg6*reg7;
    reg4=val[23]*reg4; reg13=reg14+reg13; reg4=reg13+reg4; reg12=val[24]*reg12; reg13=reg2*reg5;
    reg12=reg4+reg12; reg13=val[25]*reg13; reg4=var_inter[0]*reg10; reg13=reg12+reg13; reg4=val[26]*reg4;
    reg12=pow(var_inter[1],6); reg14=pow(var_inter[0],7); T reg15=val[27]*reg12; reg4=reg13+reg4; reg13=val[28]*reg14;
    reg15=reg4+reg15; reg4=var_inter[1]*reg11; reg13=reg15+reg13; reg15=reg1*reg9; reg4=val[29]*reg4;
    reg4=reg13+reg4; reg15=val[30]*reg15; reg13=reg7*reg8; T reg16=reg6*reg5; reg15=reg4+reg15;
    reg13=val[31]*reg13; reg13=reg15+reg13; reg16=val[32]*reg16; reg4=reg2*reg10; reg15=var_inter[0]*reg12;
    reg16=reg13+reg16; reg4=val[33]*reg4; reg4=reg16+reg4; reg15=val[34]*reg15; reg13=pow(var_inter[1],7);
    reg15=reg4+reg15; reg4=val[35]*reg13; reg16=pow(var_inter[0],8); reg16=val[36]*reg16; reg14=var_inter[1]*reg14;
    reg4=reg15+reg4; reg16=reg4+reg16; reg14=val[37]*reg14; reg11=reg1*reg11; reg14=reg16+reg14;
    reg11=val[38]*reg11; reg9=reg7*reg9; reg11=reg14+reg11; reg9=val[39]*reg9; reg5=reg8*reg5;
    reg9=reg11+reg9; reg5=val[40]*reg5; reg10=reg6*reg10; reg12=reg2*reg12; reg10=val[41]*reg10;
    reg5=reg9+reg5; reg10=reg5+reg10; reg12=val[42]*reg12; reg13=var_inter[0]*reg13; reg12=reg10+reg12;
    reg13=val[43]*reg13; reg1=pow(var_inter[1],8); reg13=reg12+reg13; reg1=val[44]*reg1; res=reg13+reg1;
...
typename TNG::T get_det_jac( const Element<Triangle,TN,TNG,TD,NET> &elem, const TVI &var_inter ) {
    ...
    reg4=elem.pos(2)[1]-elem.pos(0)[1]; T reg6=reg0/reg5; T reg7=elem.pos(2)[0]-elem.pos(0)[0]; T reg8=elem.pos(2)[2]-elem.pos(0)[2]; reg5=reg2/reg5;
    T reg9=reg3*reg7; T reg10=reg6*reg4; reg9=reg10+reg9; reg10=reg5*reg8; reg10=reg9+reg10;
    reg9=reg6*reg10; T reg11=reg3*reg10; reg9=reg4-reg9; reg11=reg7-reg11; T reg12=reg5*reg10;
    reg12=reg8-reg12; T reg13=pow(reg11,2); T reg14=pow(reg9,2); reg14=reg13+reg14; reg13=pow(reg12,2);
    reg13=reg14+reg13; reg13=pow(reg13,0.5); reg11=reg11/reg13; reg9=reg9/reg13; reg7=reg7*reg11;
    reg4=reg9*reg4; reg11=reg1*reg11; reg13=reg12/reg13; reg1=reg3*reg1; reg6=reg6*reg0;
    reg9=reg0*reg9; reg4=reg7+reg4; reg8=reg8*reg13; reg5=reg5*reg2; reg6=reg1+reg6;
    reg9=reg11+reg9; reg13=reg2*reg13; reg13=reg9+reg13; reg4=reg8+reg4; reg5=reg6+reg5;
    reg0=reg5*reg4; reg1=reg10*reg13; reg1=reg0-reg1; return reg1;
...
Vec<T,3> barycenter( const Element<Triangle,TN,Node<3,T,TNodalStaticData>,TD,NET> &elem ) {
    ...
    T reg5=reg0/reg3; T reg6=elem.pos(2)[0]-elem.pos(0)[0]; T reg7=elem.pos(2)[1]-elem.pos(0)[1]; reg3=reg2/reg3; T reg8=elem.pos(2)[2]-elem.pos(0)[2];
    T reg9=reg4*reg6; T reg10=reg5*reg7; reg10=reg9+reg10; reg9=reg3*reg8; reg9=reg10+reg9;
    reg10=reg4*reg9; T reg11=reg5*reg9; T reg12=reg3*reg9; reg10=reg6-reg10; reg11=reg7-reg11;
    reg12=reg8-reg12; T reg13=pow(reg10,2); T reg14=pow(reg11,2); reg14=reg13+reg14; reg13=pow(reg12,2);
    reg13=reg14+reg13; reg13=pow(reg13,0.5); reg10=reg10/reg13; reg11=reg11/reg13; reg14=reg0*reg11;
    T reg15=reg1*reg10; reg11=reg7*reg11; reg10=reg6*reg10; reg5=reg0*reg5; reg4=reg1*reg4;
    reg13=reg12/reg13; reg3=reg2*reg3; reg5=reg4+reg5; reg14=reg15+reg14; reg4=reg2*reg13;
    reg10=reg11+reg10; reg13=reg8*reg13; reg4=reg14+reg4; reg3=reg5+reg3; reg10=reg13+reg10;
    reg5=reg10*reg3; reg11=reg9*reg4; reg11=reg5-reg11; reg7=reg11*reg7; reg8=reg11*reg8;
    reg6=reg11*reg6; reg5=elem.pos(0)[2]*reg11; reg0=reg11*reg0; reg12=2*reg7; reg13=2*reg6;
    reg1=reg11*reg1; reg14=elem.pos(0)[1]*reg11; reg15=elem.pos(0)[0]*reg11; reg2=reg11*reg2; T reg16=2*reg8;
    T reg17=reg1-reg15; T reg18=reg2-reg5; T reg19=reg13/2; T reg20=2*reg0; T reg21=reg12/2;
    T reg22=2*reg1; T reg23=reg0-reg14; T reg24=2*reg2; T reg25=reg16/2; T reg26=reg6/2;
    reg17=reg17-reg19; T reg27=reg19-reg22; T reg28=reg7/2; reg18=reg18-reg25; T reg29=reg25-reg24;
    T reg30=reg8/2; reg23=reg23-reg21; T reg31=reg21-reg20; reg29=0.5*reg29; reg18=reg18/2;
    reg30=reg5+reg30; reg26=reg15+reg26; reg28=reg14+reg28; reg17=reg17/2; reg27=0.5*reg27;
    reg31=0.5*reg31; reg23=reg23/2; reg5=reg11/2; reg31=reg31/3; reg23=reg28+reg23;
    reg29=reg29/3; reg18=reg30+reg18; reg17=reg26+reg17; reg27=reg27/3; reg31=reg23+reg31;
    reg5=reg11-reg5; reg29=reg18+reg29; reg27=reg17+reg27; res[0]=reg27/reg5; res[2]=reg29/reg5;
    res[1]=reg31/reg5;
