...
typedef typename Pvec::template SubType<0>::T T;
    ...
    reg9=reg26*reg24; reg10=var_inter[0]*reg26; reg14=reg13*reg1; reg15=var_inter[0]*reg1; reg14=reg9-reg14;
    reg15=reg17+reg15; reg16=var_inter[1]*reg24; reg10=reg2+reg10; reg2=var_inter[1]*reg13; reg10=reg2+reg10;
    reg15=reg16+reg15; reg2=reg24/reg14; reg16=reg1/reg14; reg17=reg13/reg14; reg14=reg26/reg14;
    reg2=reg10*reg2; reg17=reg15*reg17; reg16=reg10*reg16; reg14=reg15*reg14; var_inter[0]+=reg2-reg17;
    var_inter[1]+=reg14-reg16;
