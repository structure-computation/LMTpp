...
template<class TNode> void permutation_if_jac_neg(const Quad &elem,TNode **nodes) {
    ...
    T reg5=0.5*nodes[2]->pos[0]; reg2=reg3+reg2; reg3=0.5*nodes[2]->pos[1]; T reg6=reg1+reg0; reg1=reg0-reg1;
    reg2=reg5-reg2; reg1=reg3+reg1; reg0=0.5*nodes[3]->pos[1]; reg6=reg3-reg6; reg3=0.5*nodes[3]->pos[0];
    reg5=reg4+reg5; reg6=reg6+reg0; reg0=reg1-reg0; reg5=reg5-reg3; reg2=reg3+reg2;
    reg6=reg5*reg6; reg2=reg0*reg2; T det_jac=reg6-reg2;
...
typedef typename Pvec::template SubType<0>::T T;
    T reg0=1-var_inter[1]; T reg1=1-var_inter[0]; T reg2=reg0*var_inter[0]; T reg3=reg0*reg1; T reg4=reg2*pos_nodes[1][1];
    T reg5=reg3*pos_nodes[0][1]; T reg6=var_inter[0]*pos_nodes[1][1]; T reg7=reg1*pos_nodes[0][1]; T reg8=reg0*pos_nodes[0][1]; T reg9=reg0*pos_nodes[1][1];
    T reg10=reg2*pos_nodes[1][0]; T reg11=pos_nodes[0][0]*reg3; T reg12=var_inter[0]*pos_nodes[1][0]; T reg13=var_inter[0]*var_inter[1]; T reg14=pos_nodes[0][0]*reg1;
    T reg15=reg0*pos_nodes[1][0]; T reg16=pos_nodes[0][0]*reg0; T reg17=reg1*var_inter[1]; T reg18=reg13*pos_nodes[2][1]; reg4=reg5+reg4;
    ...
    reg5=reg16+reg5; reg12=reg14-reg12; reg9=reg1*pos_nodes[3][0]; reg6=reg7-reg6; reg7=reg1*pos_nodes[3][1];
...
typedef typename Pvec::template SubType<0>::T T;
    ...
    T reg5=reg1*pos_nodes[0][1]; T reg6=reg0*pos_nodes[0][1]; T reg7=var_inter[0]*pos_nodes[1][1]; T reg8=reg2*pos_nodes[0][1]; T reg9=reg3*pos_nodes[1][1];
    T reg10=var_inter[0]*var_inter[1]; T reg11=reg3*pos_nodes[1][0]; T reg12=reg1*pos_nodes[1][0]; T reg13=pos_nodes[0][0]*reg1; T reg14=pos_nodes[0][0]*reg2;
    T reg15=pos_nodes[0][0]*reg0; T reg16=var_inter[0]*pos_nodes[1][0]; T reg17=reg0*var_inter[1]; reg13=reg12-reg13; reg12=pos_nodes[2][1]*reg10;
    reg9=reg8+reg9; reg8=var_inter[1]*pos_nodes[2][0]; reg7=reg6+reg7; reg6=var_inter[0]*pos_nodes[2][1]; T reg18=var_inter[0]*pos_nodes[2][0];
    reg11=reg14+reg11; reg14=pos_nodes[2][0]*reg10; reg5=reg4-reg5; reg4=var_inter[1]*pos_nodes[2][1]; reg16=reg15+reg16;
    reg16=reg18-reg16; reg14=reg11+reg14; reg11=pos_nodes[3][0]*reg17; reg15=pos_nodes[3][1]*reg17; reg12=reg9+reg12;
    reg9=reg0*pos_nodes[3][0]; reg18=var_inter[1]*pos_nodes[3][1]; T reg19=var_inter[1]*pos_nodes[3][0]; reg4=reg5+reg4; reg7=reg6-reg7;
    reg8=reg13+reg8; reg5=reg0*pos_nodes[3][1]; reg19=reg8-reg19; reg18=reg4-reg18; reg5=reg7+reg5;
    reg11=reg14+reg11; reg9=reg16+reg9; reg15=reg12+reg15; reg15=pos[1]-reg15; reg4=reg19*reg5;
    reg6=reg19*var_inter[0]; reg11=pos[0]-reg11; reg7=var_inter[0]*reg18; reg8=reg9*reg18; reg8=reg4-reg8;
    reg12=var_inter[1]*reg5; reg7=reg15+reg7; reg13=reg9*var_inter[1]; reg6=reg11+reg6; reg6=reg13+reg6;
    reg7=reg12+reg7; reg11=reg19/reg8; reg12=reg9/reg8; reg13=reg18/reg8; reg8=reg5/reg8;
    reg11=reg7*reg11; reg13=reg6*reg13; reg12=reg7*reg12; reg8=reg6*reg8; var_inter[1]+=reg11-reg13;
    var_inter[0]+=reg8-reg12;
...
template<class TVI,class TVAL,class T> void get_interp(const Quad &ne,const Nodal &n,const TVI &var_inter,const TVAL &val,T &res) {
    T reg0=1-var_inter[0]; T reg1=1-var_inter[1]; T reg2=var_inter[0]*reg1; reg1=reg0*reg1; T reg3=var_inter[0]*var_inter[1];
    T reg4=val[0]*reg1; T reg5=val[1]*reg2; reg4=reg5+reg4; reg5=val[2]*reg3; reg0=var_inter[1]*reg0;
...
template<class TVI,class TVAL,class T> void get_interp(const Quad &ne,const Bubble &n,const TVI &var_inter,const TVAL &val,T &res) {
    ...
    reg7=reg5+reg7; reg8=val[2]*reg8; reg4=reg0*reg4; reg8=reg7+reg8; reg4=val[3]*reg4;
