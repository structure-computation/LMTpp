...
\generic_comment static_range
    ...
    Cette fonction renvoie un vecteur dont les indices varient dans un intervalle suivant un pas constant (éventuellement différent de 1). Contrairement à \a range la taille est fixée à la compilation.
    Exemple typique :
    \code C/C++
