...
public:
    ...
    virtual bool solve(ScalarType iterative_criterium=0.0) = 0; ///  The all-in-one procedure -> allocate if necessary, assemble, solve, update_variables, call_after_solve
    ...
    virtual bool solve_system(ScalarType iterative_criterium=0.0) = 0;
