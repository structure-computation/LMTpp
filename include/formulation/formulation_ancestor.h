...
public:
    ...
    */
    ...
    virtual void call_after_solve_4(unsigned nb_thread) = 0; /// call all after_solve in carac elem ( generated by apply_on_elements_after_solve_3() in formulation_...py )
    virtual void call_after_solve_5(unsigned nb_thread) = 0; /// call all after_solve in carac elem ( generated by apply_on_elements_after_solve_3() in formulation_...py )
    virtual void call_after_solve_6(unsigned nb_thread) = 0; /// call all after_solve in carac elem ( generated by apply_on_elements_after_solve_3() in formulation_...py )
