...
public:
    ...
    T reg0=elem.pos(2)[1]-elem.pos(0)[1]; T reg1=elem.pos(2)[0]-elem.pos(0)[0]; T reg2=elem.pos(1)[1]-elem.pos(0)[1]; T reg3=elem.pos(1)[0]-elem.pos(0)[0]; T reg4=reg2*reg1;
    T reg5=reg3*reg0; reg4=reg5-reg4; reg5=vectors[0][indices[1]+0]-vectors[0][indices[0]+0]; reg0=reg0/reg4; reg3=reg3/reg4;
    T reg6=vectors[0][indices[1]+1]-vectors[0][indices[0]+1]; reg1=reg1/reg4; T reg7=vectors[0][indices[2]+1]-vectors[0][indices[0]+1]; reg4=reg2/reg4; reg2=vectors[0][indices[2]+0]-vectors[0][indices[0]+0];
    T reg8=reg2*reg3; T reg9=reg5*reg1; T reg10=reg6*reg0; T reg11=reg7*reg4; reg9=reg8-reg9;
    reg11=reg10-reg11; reg5=reg5*reg0; reg11=reg9+reg11; reg6=reg6*reg1; reg7=reg7*reg3;
    reg2=reg2*reg4; elem.epsilon[0][2]=0.5*reg11; elem.epsilon[0][1]=reg7-reg6; elem.epsilon[0][0]=reg5-reg2;
      #undef PNODE
    }
...
public:
  ...
  template<class TE,class TTs,class Tvec>
  inline static void set_nodal_unknowns(TE &node,const TTs &f,const Tvec &vecs,unsigned indice) {
    node.lum=vecs[0][indice+2]; node.dep[0]=vecs[0][indice+0]; node.dep[1]=vecs[0][indice+1];
  }
  template<class TE,class TTs,class Tvec>
  inline static void set_nodal_unknowns(TE &node,const TTs &f,const Tvec &vecs,unsigned indice,T partial_ts) {
    node.dep[0]=vecs[0][indice+0]; node.lum=vecs[0][indice+2]; node.dep[1]=vecs[0][indice+1];
...
public:
    ...
    template<class TE,class TF, class TVEVE> static void after_solve(TE &elem,TF &f,TVEVE &vectors,const unsigned *indices) {
      #define PNODE(N) (*elem.node(N))
    T reg0=elem.pos(2)[0]+elem.pos(0)[0]; T reg1=elem.pos(1)[1]+elem.pos(0)[1]; T reg2=2*elem.pos(3)[0]; T reg3=elem.pos(1)[0]+elem.pos(0)[0]; T reg4=2*elem.pos(3)[1];
    T reg5=elem.pos(2)[1]+elem.pos(0)[1]; reg1=reg1-reg4; reg0=reg0-reg2; T reg6=2*elem.pos(4)[0]; reg3=reg3-reg2;
    ...
    reg1=reg1-reg3; reg6=reg6-reg8; reg7=reg7-reg3; reg10=reg10-reg11; reg5=reg5-reg11;
    T reg14=2*vectors[0][indices[4]+1]; reg9=reg9-reg13; T reg15=2*vectors[0][indices[4]+0]; reg12=reg12-reg13; T reg16=reg7*reg6;
    T reg17=reg1*reg0; reg10=reg14+reg10; T reg18=2*vectors[0][indices[5]+1]; reg5=reg14+reg5; reg12=reg12+reg15;
    reg17=reg16-reg17; reg9=reg15+reg9; reg14=2*vectors[0][indices[5]+0]; reg6=reg6/reg17; reg7=reg7/reg17;
    reg9=reg9-reg14; reg1=reg1/reg17; reg5=reg5-reg18; reg17=reg0/reg17; reg12=reg12-reg14;
    reg10=reg10-reg18; reg0=reg1*reg5; reg15=reg7*reg10; reg16=reg12*reg17; T reg19=reg9*reg6;
    reg0=reg15-reg0; reg16=reg19-reg16; reg0=reg16+reg0; reg10=reg17*reg10; reg5=reg6*reg5;
    reg12=reg7*reg12; reg9=reg1*reg9; elem.epsilon[0][2]=0.5*reg0; elem.epsilon[0][1]=reg5-reg10; elem.epsilon[0][0]=reg12-reg9;
      #undef PNODE
    }
    template<class TE,class TF, class TVEVE> static void after_solve_2(TE &elem,TF &f,TVEVE &vectors,const unsigned *indices) {
      #define PNODE(N) (*elem.node(N))
...
public:
    ...
    template<class TE,class TF, class TVEVE> static void after_solve(TE &elem,TF &f,TVEVE &vectors,const unsigned *indices) {
      #define PNODE(N) (*elem.node(N))
    T reg0=0.5*elem.pos(0)[1]; T reg1=0.5*elem.pos(1)[1]; T reg2=0.5*elem.pos(0)[0]; T reg3=0.5*elem.pos(1)[0]; T reg4=0.5*elem.pos(2)[1];
    T reg5=reg0+reg1; T reg6=0.5*elem.pos(2)[0]; T reg7=reg3-reg2; reg0=reg1-reg0; reg2=reg3+reg2;
    reg0=reg4+reg0; reg1=0.5*elem.pos(3)[0]; reg7=reg6+reg7; reg2=reg6-reg2; reg3=0.5*elem.pos(3)[1];
    reg5=reg4-reg5; reg2=reg1+reg2; reg4=0.5*vectors[0][indices[0]+1]; reg0=reg0-reg3; reg6=0.5*vectors[0][indices[1]+0];
    T reg8=0.5*vectors[0][indices[0]+0]; T reg9=0.5*vectors[0][indices[1]+1]; reg1=reg7-reg1; reg3=reg5+reg3; reg5=reg9+reg4;
    reg7=0.5*vectors[0][indices[2]+0]; T reg10=reg6+reg8; T reg11=0.5*vectors[0][indices[2]+1]; reg8=reg6-reg8; reg4=reg9-reg4;
    reg6=reg0*reg2; reg9=reg3*reg1; T reg12=0.5*vectors[0][indices[3]+1]; reg5=reg11-reg5; reg4=reg11+reg4;
    reg6=reg9-reg6; reg10=reg7-reg10; reg9=0.5*vectors[0][indices[3]+0]; reg7=reg8+reg7; reg2=reg2/reg6;
    reg4=reg4-reg12; reg3=reg3/reg6; reg1=reg1/reg6; reg12=reg5+reg12; reg7=reg7-reg9;
    reg6=reg0/reg6; reg10=reg9+reg10; reg0=reg10*reg1; reg5=reg7*reg2; reg8=reg3*reg4;
    reg9=reg6*reg12; reg5=reg0-reg5; reg9=reg8-reg9; reg7=reg3*reg7; reg1=reg12*reg1;
    reg10=reg6*reg10; reg2=reg4*reg2; reg9=reg5+reg9; elem.epsilon[0][2]=0.5*reg9; elem.epsilon[0][1]=reg1-reg2;
    elem.epsilon[0][0]=reg7-reg10;
      #undef PNODE
    }
    template<class TE,class TF, class TVEVE> static void after_solve_2(TE &elem,TF &f,TVEVE &vectors,const unsigned *indices) {
      #define PNODE(N) (*elem.node(N))
...
public:
  ...
  template<class TE,class TTs,class Tvec>
  inline static void set_nodal_unknowns(TE &node,const TTs &f,const Tvec &vecs,unsigned indice,T partial_ts) {
    node.dep[1]=vecs[0][indice+1]; node.dep[2]=vecs[0][indice+2]; node.lum=vecs[0][indice+3]; node.dep[0]=vecs[0][indice+0];
  }
  template<class TE,class TTs,class Tvec>
  inline static void get_nodal_initial_conditions(const TE &node,const TTs &f,Tvec &vecs,unsigned indice) {
    vecs[0][indice+0]=node.dep[0]; vecs[1][indice+0]=node.dep[0]; vecs[2][indice+0]=node.dep[0]; vecs[3][indice+0]=node.dep[0]; vecs[4][indice+0]=node.dep[0];
  ...
  inline static T max_nodal_error(const TE &node,const TTs &f,const Tvec &vecs,int indice) {
    ...
    T reg3=vecs[1][indice+3]-vecs[0][indice+3]; reg2=abs(reg2); reg0=max(reg1,reg0); reg0=max(reg2,reg0); reg3=abs(reg3);
    return max(reg3,reg0);
  }
  template<class TE,class TTs,class Tvecs,class Tvec>
  inline static void set_old_vec_nodal(const TE &node,const TTs &f,const Tvecs &vecs,Tvec &old_vec,int indice) {
    old_vec[indice+1]=vecs[1][indice+1]; old_vec[indice+3]=vecs[1][indice+3]; old_vec[indice+2]=vecs[1][indice+2]; old_vec[indice+0]=vecs[1][indice+0];
  }
...
public:
    ...
    T reg5=elem.pos(3)[1]-elem.pos(0)[1]; T reg6=reg2*reg5; T reg7=reg1*reg5; T reg8=reg3*reg4; T reg9=reg0*reg4;
    reg7=reg9-reg7; reg9=elem.pos(1)[0]-elem.pos(0)[0]; reg6=reg8-reg6; reg8=reg3*reg1; T reg10=elem.pos(2)[0]-elem.pos(0)[0];
    T reg11=reg2*reg0; T reg12=reg9*reg7; T reg13=reg10*reg6; reg11=reg8-reg11; reg8=elem.pos(3)[0]-elem.pos(0)[0];
    T reg14=reg9*reg5; T reg15=reg2*reg8; T reg16=reg3*reg8; reg13=reg12-reg13; reg12=reg0*reg8;
    T reg17=reg8*reg11; T reg18=reg9*reg4; reg4=reg10*reg4; reg5=reg10*reg5; reg8=reg1*reg8;
    reg3=reg3*reg10; reg0=reg9*reg0; reg10=reg2*reg10; reg1=reg9*reg1; reg16=reg14-reg16;
    reg15=reg18-reg15; reg17=reg13+reg17; reg12=reg5-reg12; reg8=reg4-reg8; reg2=vectors[0][indices[2]+2]-vectors[0][indices[0]+2];
    reg4=vectors[0][indices[1]+2]-vectors[0][indices[0]+2]; reg7=reg7/reg17; reg8=reg8/reg17; reg12=reg12/reg17; reg6=reg6/reg17;
    reg15=reg15/reg17; reg16=reg16/reg17; reg10=reg1-reg10; reg3=reg0-reg3; reg0=vectors[0][indices[1]+1]-vectors[0][indices[0]+1];
    reg1=vectors[0][indices[2]+1]-vectors[0][indices[0]+1]; reg5=vectors[0][indices[1]+0]-vectors[0][indices[0]+0]; reg9=vectors[0][indices[2]+0]-vectors[0][indices[0]+0]; reg10=reg10/reg17; reg13=reg2*reg6;
    reg14=vectors[0][indices[3]+0]-vectors[0][indices[0]+0]; reg11=reg11/reg17; reg18=reg4*reg8; T reg19=reg2*reg15; T reg20=reg1*reg16;
    T reg21=reg0*reg12; T reg22=reg5*reg12; T reg23=reg9*reg16; T reg24=vectors[0][indices[3]+1]-vectors[0][indices[0]+1]; T reg25=reg4*reg7;
    T reg26=vectors[0][indices[3]+2]-vectors[0][indices[0]+2]; reg17=reg3/reg17; reg3=reg1*reg6; T reg27=reg0*reg7; T reg28=reg9*reg15;
    T reg29=reg5*reg8; reg23=reg22-reg23; reg22=reg14*reg17; T reg30=reg24*reg17; reg20=reg21-reg20;
    reg18=reg19-reg18; reg19=reg26*reg10; reg21=reg26*reg11; reg29=reg28-reg29; reg28=reg14*reg10;
    T reg31=reg24*reg11; reg13=reg25-reg13; reg3=reg27-reg3; reg0=reg0*reg8; reg23=reg22+reg23;
    reg4=reg4*reg12; reg1=reg1*reg15; reg2=reg2*reg16; reg20=reg30+reg20; reg31=reg3+reg31;
    reg9=reg9*reg6; reg28=reg29-reg28; reg19=reg18-reg19; reg21=reg13+reg21; reg5=reg5*reg7;
    reg28=reg31+reg28; reg23=reg21+reg23; reg19=reg20+reg19; reg9=reg5-reg9; reg14=reg14*reg11;
    reg0=reg1-reg0; reg24=reg24*reg10; reg2=reg4-reg2; reg26=reg26*reg17; elem.epsilon[0][4]=0.5*reg23;
    elem.epsilon[0][5]=0.5*reg19; elem.epsilon[0][0]=reg9+reg14; elem.epsilon[0][3]=0.5*reg28; elem.epsilon[0][1]=reg0-reg24; elem.epsilon[0][2]=reg26+reg2;
      #undef PNODE
    }
    template<class TE,class TF, class TVEVE> static void after_solve_2(TE &elem,TF &f,TVEVE &vectors,const unsigned *indices) {
      #define PNODE(N) (*elem.node(N))
...
public:
  ...
  template<class TE,class TTs,class Tvec>
  inline static void set_nodal_unknowns(TE &node,const TTs &f,const Tvec &vecs,unsigned indice) {
    node.lum=vecs[0][indice+3]; node.dep[2]=vecs[0][indice+2]; node.dep[1]=vecs[0][indice+1]; node.dep[0]=vecs[0][indice+0];
  }
  template<class TE,class TTs,class Tvec>
  inline static void set_nodal_unknowns(TE &node,const TTs &f,const Tvec &vecs,unsigned indice,T partial_ts) {
    node.dep[1]=vecs[0][indice+1]; node.dep[2]=vecs[0][indice+2]; node.lum=vecs[0][indice+3]; node.dep[0]=vecs[0][indice+0];
  ...
  inline static T max_nodal_error(const TE &node,const TTs &f,const Tvec &vecs,int indice) {
    ...
    reg0=max(reg1,reg0); reg2=abs(reg2); reg1=vecs[1][indice+3]-vecs[0][indice+3]; reg1=abs(reg1); reg0=max(reg2,reg0);
    return max(reg1,reg0);
  }
  template<class TE,class TTs,class Tvecs,class Tvec>
  inline static void set_old_vec_nodal(const TE &node,const TTs &f,const Tvecs &vecs,Tvec &old_vec,int indice) {
    old_vec[indice+2]=vecs[1][indice+2]; old_vec[indice+3]=vecs[1][indice+3]; old_vec[indice+0]=vecs[1][indice+0]; old_vec[indice+1]=vecs[1][indice+1];
  }
...
public:
    ...
    template<class TE,class TF, class TVEVE> static void after_solve(TE &elem,TF &f,TVEVE &vectors,const unsigned *indices) {
      #define PNODE(N) (*elem.node(N))
    T reg0=0.25*elem.pos(1)[1]; T reg1=0.25*elem.pos(0)[1]; T reg2=0.25*elem.pos(1)[2]; T reg3=0.25*elem.pos(0)[2]; T reg4=reg2-reg3;
    T reg5=0.25*elem.pos(2)[1]; T reg6=reg0+reg1; reg3=reg2+reg3; reg2=0.25*elem.pos(2)[2]; reg1=reg0-reg1;
    reg4=reg2+reg4; reg0=reg5+reg6; reg6=reg5-reg6; T reg7=0.25*elem.pos(3)[1]; T reg8=0.25*elem.pos(0)[0];
    T reg9=0.25*elem.pos(1)[0]; reg1=reg5+reg1; reg5=reg2-reg3; T reg10=0.25*elem.pos(3)[2]; reg2=reg3+reg2;
    reg3=0.25*elem.pos(4)[2]; T reg11=0.25*elem.pos(4)[1]; reg6=reg6+reg7; reg5=reg10+reg5; reg2=reg2+reg10;
    T reg12=reg9-reg8; reg1=reg1-reg7; T reg13=0.25*elem.pos(2)[0]; reg0=reg7+reg0; reg10=reg4-reg10;
    reg8=reg9+reg8; reg2=reg3-reg2; reg4=0.25*elem.pos(5)[2]; reg7=0.25*elem.pos(5)[1]; reg6=reg6-reg11;
    reg9=reg13-reg8; reg5=reg5-reg3; reg0=reg11-reg0; reg3=reg10-reg3; reg11=reg1-reg11;
    reg12=reg12+reg13; reg1=0.25*elem.pos(3)[0]; reg9=reg1+reg9; reg10=0.25*elem.pos(6)[2]; reg2=reg2+reg4;
    reg5=reg5-reg4; reg0=reg7+reg0; T reg14=0.25*elem.pos(6)[1]; reg6=reg6-reg7; reg8=reg13+reg8;
    reg11=reg7+reg11; reg3=reg4+reg3; reg12=reg12-reg1; reg4=0.25*elem.pos(4)[0]; reg7=0.25*vectors[0][indices[1]+2];
    reg12=reg12-reg4; reg13=0.25*vectors[0][indices[0]+1]; T reg15=0.25*elem.pos(5)[0]; reg0=reg14+reg0; reg9=reg9-reg4;
    T reg16=0.25*vectors[0][indices[1]+1]; reg3=reg10+reg3; reg8=reg1+reg8; reg1=0.25*vectors[0][indices[0]+2]; reg11=reg14+reg11;
    T reg17=0.25*vectors[0][indices[0]+0]; reg14=reg6+reg14; reg6=0.25*elem.pos(7)[1]; reg2=reg2+reg10; T reg18=0.25*elem.pos(7)[2];
    T reg19=0.25*vectors[0][indices[1]+0]; reg5=reg10+reg5; reg10=0.25*vectors[0][indices[2]+2]; T reg20=reg7+reg1; reg3=reg3-reg18;
    reg11=reg11-reg6; reg8=reg4-reg8; reg9=reg9-reg15; reg1=reg7-reg1; reg4=reg13+reg16;
    reg13=reg16-reg13; reg7=reg19+reg17; reg16=0.25*vectors[0][indices[2]+0]; T reg21=0.25*vectors[0][indices[2]+1]; reg14=reg14+reg6;
    reg17=reg19-reg17; reg2=reg2+reg18; reg5=reg18+reg5; reg0=reg6+reg0; reg12=reg12+reg15;
    reg6=0.25*elem.pos(6)[0]; reg18=reg16-reg7; reg19=0.25*vectors[0][indices[3]+1]; T reg22=reg21-reg4; reg13=reg21+reg13;
    T reg23=0.25*vectors[0][indices[3]+0]; reg17=reg17+reg16; reg8=reg15+reg8; reg15=reg10-reg20; T reg24=0.25*vectors[0][indices[3]+2];
    T reg25=reg0*reg3; T reg26=reg2*reg11; reg9=reg6+reg9; T reg27=reg14*reg2; reg1=reg10+reg1;
    T reg28=0.25*elem.pos(7)[0]; reg12=reg12+reg6; T reg29=reg5*reg0; reg17=reg17-reg23; T reg30=0.25*vectors[0][indices[4]+0];
    reg13=reg13-reg19; reg15=reg24+reg15; T reg31=0.25*vectors[0][indices[4]+1]; reg1=reg1-reg24; reg18=reg23+reg18;
    reg22=reg22+reg19; reg7=reg16+reg7; reg10=reg20+reg10; reg29=reg27-reg29; reg4=reg21+reg4;
    reg16=0.25*vectors[0][indices[4]+2]; reg20=reg14*reg3; reg21=reg5*reg11; reg12=reg12-reg28; reg8=reg6+reg8;
    reg9=reg28+reg9; reg25=reg26-reg25; reg15=reg15-reg16; reg22=reg22-reg31; reg6=0.25*vectors[0][indices[5]+1];
    reg13=reg13-reg31; reg4=reg19+reg4; reg10=reg24+reg10; reg19=0.25*vectors[0][indices[5]+2]; reg1=reg1-reg16;
    reg24=reg29*reg12; reg26=reg9*reg25; reg18=reg18-reg30; reg8=reg28+reg8; reg20=reg21-reg20;
    reg17=reg17-reg30; reg21=0.25*vectors[0][indices[5]+0]; reg7=reg23+reg7; reg23=0.25*vectors[0][indices[6]+0]; reg27=0.25*vectors[0][indices[6]+2];
    reg13=reg6+reg13; reg28=reg0*reg12; reg17=reg21+reg17; T reg32=reg8*reg20; T reg33=reg11*reg8;
    T reg34=reg5*reg8; T reg35=reg2*reg9; reg26=reg24-reg26; reg4=reg31-reg4; reg7=reg30-reg7;
    reg15=reg15-reg19; reg2=reg2*reg12; reg24=reg3*reg8; reg8=reg14*reg8; reg0=reg0*reg9;
    reg1=reg19+reg1; reg18=reg18-reg21; reg10=reg16-reg10; reg22=reg22-reg6; reg16=0.25*vectors[0][indices[6]+1];
    reg19=reg10+reg19; reg10=0.25*vectors[0][indices[7]+2]; reg1=reg27+reg1; reg8=reg0-reg8; reg11=reg9*reg11;
    reg14=reg14*reg12; reg4=reg6+reg4; reg32=reg26+reg32; reg7=reg21+reg7; reg33=reg28-reg33;
    reg15=reg27+reg15; reg3=reg9*reg3; reg12=reg5*reg12; reg18=reg23+reg18; reg24=reg2-reg24;
    reg22=reg22+reg16; reg0=0.25*vectors[0][indices[7]+1]; reg13=reg16+reg13; reg17=reg23+reg17; reg2=0.25*vectors[0][indices[7]+0];
    reg34=reg35-reg34; reg25=reg25/reg32; reg18=reg2+reg18; reg19=reg27+reg19; reg15=reg10+reg15;
    reg24=reg24/reg32; reg8=reg8/reg32; reg7=reg23+reg7; reg17=reg17-reg2; reg22=reg0+reg22;
    reg34=reg34/reg32; reg1=reg1-reg10; reg11=reg14-reg11; reg13=reg13-reg0; reg33=reg33/reg32;
    reg4=reg16+reg4; reg3=reg12-reg3; reg29=reg29/reg32; reg5=reg13*reg8; reg6=reg22*reg33;
    reg9=reg18*reg33; reg12=reg17*reg34; reg14=reg18*reg24; reg10=reg19+reg10; reg11=reg11/reg32;
    reg16=reg24*reg15; reg4=reg0+reg4; reg3=reg3/reg32; reg0=reg34*reg1; reg19=reg17*reg8;
    reg21=reg29*reg1; reg23=reg29*reg13; reg26=reg25*reg22; reg7=reg2+reg7; reg32=reg20/reg32;
    reg2=reg25*reg15; reg20=reg4*reg11; reg27=reg32*reg4; reg26=reg23-reg26; reg23=reg7*reg3;
    reg12=reg14-reg12; reg9=reg19-reg9; reg6=reg5-reg6; reg5=reg7*reg11; reg0=reg16-reg0;
    reg14=reg3*reg10; reg2=reg21-reg2; reg16=reg32*reg10; reg5=reg9+reg5; reg16=reg2+reg16;
    reg27=reg26+reg27; reg23=reg12-reg23; reg15=reg33*reg15; reg1=reg8*reg1; reg6=reg20+reg6;
    reg13=reg34*reg13; reg22=reg24*reg22; reg14=reg0-reg14; reg18=reg25*reg18; reg17=reg29*reg17;
    reg16=reg5+reg16; reg14=reg6+reg14; reg27=reg23+reg27; reg15=reg1-reg15; reg10=reg11*reg10;
    reg4=reg3*reg4; reg13=reg22-reg13; reg7=reg32*reg7; reg18=reg17-reg18; elem.epsilon[0][3]=0.5*reg27;
    elem.epsilon[0][4]=0.5*reg16; elem.epsilon[0][2]=reg10+reg15; elem.epsilon[0][1]=reg13-reg4; elem.epsilon[0][0]=reg18+reg7; elem.epsilon[0][5]=0.5*reg14;
      #undef PNODE
    }
    template<class TE,class TF, class TVEVE> static void after_solve_2(TE &elem,TF &f,TVEVE &vectors,const unsigned *indices) {
      #define PNODE(N) (*elem.node(N))
