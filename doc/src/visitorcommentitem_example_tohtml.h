#ifndef VISITOR_COMMENT_ITEM_EXAMPLE_TO_HTML_H
#define VISITOR_COMMENT_ITEM_EXAMPLE_TO_HTML_H
...
struct VisitorCommentItem_example_toHTML : public VisitorCommentItem  {
    VisitorCommentItem_example_toHTML( ListTarget* plt, map<string,string>* pt  ) { ptr_list_target = plt ; ptr_tree = pt ; }
    virtual ~VisitorCommentItem_example_toHTML() {}
