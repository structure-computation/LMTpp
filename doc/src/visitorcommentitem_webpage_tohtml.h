#ifndef VISITOR_COMMENT_ITEM_WEBPAGE_TO_HTML_H
#define VISITOR_COMMENT_ITEM_WEBPAGE_TO_HTML_H
...
struct VisitorCommentItem_webpage_toHTML : public VisitorCommentItem  {
    VisitorCommentItem_webpage_toHTML( ListTarget* plt,map<string,string>* pt  ) { ptr_list_target = plt ; ptr_tree = pt ; }
    virtual ~VisitorCommentItem_webpage_toHTML() {}
