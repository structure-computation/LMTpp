...
string french2webID( const string& s) {
    ...
    for(i=0;i<n;i++) {
        ...
        if((short)s[i] != -61) t  += tolower(s[i]);
                ...
                switch((short) s[i+1]){
                        case -87 : t += "e"; break; // corespond à la lettre é
                        case -96 : t += "a"; break; // corespond à la lettre à
                        case -88 : t += "e"; break; // corespond à la lettre è
                        case -86 : t += "e"; break; // corespond à la lettre ê
                        case -89 : t += "c"; break; // corespond à la lettre ç /// il manque le ù
                        default: t += "INCONNU";
                        }
...
string french2HTML( const string& s) {
    ...
    for(i=0;i<n;i++) {
        ...
        if( (short)s[i] != -61)
            ...
            switch( (short)s[i+1] ){
                    case -87 : t += "&eacute;"; break; // corespond à la lettre é
                    case -96 : t += "&agrave;"; break; // corespond à la lettre à
                    case -88 : t += "&egrave;"; break; // corespond à la lettre è
                    case -86 : t += "&ecirc;"; break; // corespond à la lettre ê
                    case -89 : t += "&ccedil;"; break; // corespond à la lettre ç
                    case -71 : t += "&ugrave;"; break; // corespond à la lettre ù
                    ...
                    default: 
                        std::cerr << "Caractère utf-8 non géré (" << (short)s[i+1] << " cf. " << __FILE__ << ":" << __LINE__ << ")"  << std::endl;
            }
            i++; // pour sauter le deuxième octet
        }
    }
...
=======
    ...
    string stmp,stmp2;
    string html;
>>>>>>> 3f9a28546b394bea60e8ea0b0587eca16d820a0d:doc/src/util2html.cpp
    char c;
    Target* ptr_t;
