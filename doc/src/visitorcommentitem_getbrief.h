#ifndef VISITOR_COMMENT_ITEM_GET_BRIEF_H
#define VISITOR_COMMENT_ITEM_GET_BRIEF_H
...
struct ListTarget ;
struct List_Target_brief ;

struct VisitorCommentItem_getBrief : public VisitorCommentItem  {
    VisitorCommentItem_getBrief ( ) { }
    virtual ~VisitorCommentItem_getBrief () {}
