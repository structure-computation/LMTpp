...
int pol_degree_4_double_univariable_0() {
    ...
    bool r0 = ERROR_UNIT_TEST( sol[0] ,C( .120557492003962 ) ) < prec;
    bool r1 = ERROR_UNIT_TEST( sol[1] ,C( -.870432417520779, .603404119273391 ) ) < prec;
    bool r2 = ERROR_UNIT_TEST( sol[2] ,C( -.870432417520779,-.603404119273391 ) ) < prec;
    bool r3 = ERROR_UNIT_TEST( sol[3] ,C( -18090561.2470167 ) ) < prec;
